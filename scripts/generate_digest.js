...
const CONTENT = {
  ...
  editionNo: "Vol. I — Edition 037",

  execSummary: [
    { tag: "HIGH", color: RED_RISK, text: "TODAY, the Greater Bengaluru Authority formally replaces BBMP. Leadership is now confirmed: Chief Minister Siddaramaiah is GBA Chairperson, Deputy CM D.K. Shivakumar is Vice-Chairperson, and M. Maheshwar Rao (outgoing BBMP Chief Commissioner) is GBA Chief Commissioner & Member-Secretary. Bengaluru is now formally split into 5 city corporations — Central (Hudson Circle), North (Yelahanka), East (Mahadevapura), West (RR Nagar) and South (Jayanagar). Confirm all time-sensitive NBR khata/tax/approval filings are routed to the correct corporation from today." },
    { tag: "INFO", color: NAVY, text: "Karnataka HC (Justice M. Nagaprasanna, Amit Garg v. Karnataka RERA) has held that the K-RERA Registry has no power to decide a complaint's maintainability by email — only Tribunal/Authority members can adjudicate that question; the Court quashed an email rejection and restored the complaint for proper hearing. A useful procedural safeguard against future Registry-level dismissals, newly surfaced in this digest's research." },
    { tag: "INFO", color: NAVY, text: "Otherwise a quiet day: no new Grade A/mid-tier Bengaluru land deal since Puravankara's Electronic City JDA and Brigade's Whitefield buy, no public BDA response to the BBC Governor petition, and no developments in TNRERA, HYDRAA, Amaravati or Kerala beyond what is already on file. No new NBR-specific news." },
  ],
  ...
  layer1: {
    regulatory: [
      ...
      ["BBMP → GBA Transition", "The administrative handover has taken effect TODAY (2 September 2026): GBA formally replaces BBMP, with CM Siddaramaiah as Chairperson, Deputy CM D.K. Shivakumar as Vice-Chairperson, and M. Maheshwar Rao (outgoing BBMP Chief Commissioner) as GBA Chief Commissioner & Member-Secretary. Bengaluru is now formally split into 5 city corporations — Central (Hudson Circle HQ), North (Yelahanka), East (Mahadevapura), West (RR Nagar) and South (Jayanagar) — with GBA as the pan-city coordinating body. Civic ELECTIONS remain on a separate, later track — the Supreme Court extended the poll deadline from 31 August to 31 December 2026, citing the ongoing Special Intensive Revision (SIR) of electoral rolls (concluding only by November). Karnataka BJP has a separate SC plea alleging the state government deliberately delayed polls fearing electoral loss.", "With the handover now in effect, confirm every time-sensitive NBR khata/tax/approval filing is routed to the correct one of the 5 new corporations by micro-market (Central/North/East/West/South) — misrouting during this transition week is the most immediate operational risk. Elected local governance (and any associated policy shifts) remains unsettled until at least December 2026 — a materially longer governance-uncertainty window than originally assumed. The BJP's political challenge adds a layer of uncertainty to whether even the December deadline holds."],
