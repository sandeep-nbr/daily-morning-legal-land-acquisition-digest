...
const CONTENT = {
  ...
  editionNo: "Vol. I — Edition 060",

  execSummary: [
    { tag: "WATCH", color: AMBER_WATCH, text: "The Siddhartha Vihar Trust BDA civic-amenity-site complaint (Congress president Mallikarjun Kharge's family-linked trust) has escalated procedurally: following the 10 Sept affidavit cure and the special court's 18 Sept order permitting the complaint to proceed, the court has now issued formal notice to the Bengaluru Police Commissioner's office AND the Karnataka Lokayukta, directing Lokayukta police to file their response by 6 October 2026 — the first time an anti-corruption body has been formally drawn into this matter. Still a procedural matter with no finding on the merits, but 6 Oct is now the next concrete date to track in this pattern of scrutiny on BDA's own land-allotment decisions." },
    { tag: "INFO", color: NAVY, text: "Otherwise incremental: the Election Commission has further revised the SIR electoral-roll schedule underlying the GBA civic-election timeline (qualifying date now 1 Oct 2026; final roll publication 19 Oct 2026), a Karnataka HC ruling (25 Sept) struck down land-use limits under the state's Renewable Energy Policy for developers on self-acquired land (a tangential but notable precedent on the limits of Karnataka's land-use-restriction powers), and coverage this week confirmed the DRDO/CAIR-restoration ruling covers 127 acres at Benniganahalli. No update on the Karanth Layout admin-fee dispute, the BBC (South)/Peripheral Ring Road-2 naming-ambiguity question, the Madras HC TNRERA ruling, or HYDRAA/Amaravati/Kerala beyond what is on file. No new Grade A/mid-tier Bengaluru land deal and no new NBR-specific news." },
  ],
  ...
  layer1: {
    regulatory: [
      ...
      ["BBMP → GBA Transition", "The administrative handover took effect 2 September 2026: GBA formally replaced BBMP, with CM Siddaramaiah as Chairperson, Deputy CM D.K. Shivakumar as Vice-Chairperson, and M. Maheshwar Rao (outgoing BBMP Chief Commissioner) as GBA Chief Commissioner & Member-Secretary, across 5 new city corporations (Central/North/East/West/South). Civic ELECTIONS remain on a separate, later track: the Election Commission has now issued a further-REVISED SIR schedule with 1 October 2026 as the qualifying date — Claims & Objections ran 17 Aug–16 Sept 2026 (now closed), a Notice Phase & Disposal of Claims/Objections period runs 17 Aug–15 Oct 2026, and final electoral-roll publication is set for 19 Oct 2026 — superseding the \"24 Aug–23 Sept, disposal by 22 Oct\" schedule previously on file with a slightly different (but still pre-November) timeline. This remains a mild positive signal for the Supreme Court's 31 December 2026 poll deadline holding. Karnataka BJP's separate SC plea (alleging deliberate delay) remains pending.", "Confirm every time-sensitive NBR khata/tax/approval filing is routed to the correct one of the 5 new corporations by micro-market — the transition-week routing risk is now the operative near-term concern rather than the handover date itself. The now-twice-revised SIR schedule (final roll publication 19 Oct) is worth noting as a modest de-risking of the December election deadline, though the repeated revisions themselves are a reminder that these dates can still shift again, and the BJP's pending SC challenge keeps some uncertainty live."],
    ...
    landAcquisition: [
      ...
      ["Sulikere Transport Hub — CLU to Residential Flagged", "BDA has notified a change of land use converting 17.49 acres in Sulikere, off Mysuru Road (western Bengaluru), from its originally-notified transport-hub purpose to residential use — Deccan Herald reports 49 residential sites had reportedly already been formed on part of the land years ago without the mandatory state government approval, raising the question of whether BDA itself bypassed its own planning/approval process on a project it controls.", "A further instance of BDA's own land dealings drawing scrutiny (alongside Hebbal KIADB fraud, D.B. Chandregowda favouritism and other entries already on file) — reinforces that NBR should independently verify the ORIGINAL notified purpose and approval trail of any BDA-sourced site, not just its current land-use classification, since a site's residential status may itself rest on an unauthorised conversion."],
      ...
      ["Dr K Shivaram Karanth Layout — Public Applications Open (Allotment Still Restrained); Admin-Fee Pushback", "BDA began actual site allotment to ~3,200 land-giving farmers/landowners (~18,400 of 34,992 total sites, per the 40:60/60:40 compensation-ratio formula) on 31 Aug 2026 at the ₹6,000/sq ft (₹64,584/sq m) rate already on file, and has now (20 Sept 2026) invited formal objections from those landowners to the proposed allotment before finalising it, with a fixed deadline after which late objections will not be considered. Separately, the same 31 Aug notification opened general-public applications for 2,815 further sites, with the online window running until 15 Oct 2026, 12 noon — following a Karnataka HC special-bench order (Justices M. Nagaprasanna and T. Venkatesh Naik) permitting BDA to accept applications while expressly clarifying that doing so does NOT amount to permission for actual allotment, which remains restrained pending further court orders. Landowners have separately objected to a proposed ₹54,000 administrative/development fee for a standard 30×40 site as excessive, and reports indicate this could be negotiated down to roughly ₹12,000 following discussions with BDA — a formal fee notification is still awaited.", "Three distinct tracks are now running in parallel: land-giver allotment (now with a formal objection window before finalisation, and a live fee dispute that could materially change the landowner's net cost per site), a separate 2,815-site general-public application window (deadline 15 Oct) whose actual allotment remains legally restrained, and BDA's stated intent to proceed strictly by the rules once the objection deadline passes. NBR should not assume the public-application phase converts into confirmed site supply on any fixed timeline — track the HC's further orders and the final administrative-fee figure before treating these 2,815 sites as a firm future supply/comparable data point."],
...
["\"Bengaluru Business Corridor\" (South) / Peripheral Ring Road-2 — Final Notification", "The state issued a final land-acquisition notification (5 Sept 2026, per Vijay Karnataka) for 1,427.34 acres across 31 villages for a 52-km road connecting Mysuru Road to Hosur Road via Jigani, Bommasandra and Attibele — an 8-lane, 65m-wide carriageway within a 100m corridor. This is reported under the same \"Bengaluru Business Corridor\" name (and also as \"Peripheral Ring Road-2\") as the 74-km ex-PRR project already tracked in this digest (Tumakuru Road–Hosur Road, ~1,810 acres, ~948 acres notified 2008) — the routing described (a southern loop via Jigani/Bommasandra/Attibele) does not match the tracked project's alignment, suggesting these may be two distinct corridors sharing a name in press coverage, or inconsistent reporting of one project. Not yet resolved.", "Treat this as an open research item rather than settled fact — if it is genuinely a second, distinct southern corridor, it represents a fresh land-acquisition/compensation-opportunity zone (Jigani/Bommasandra/Attibele) outside NBR's core corridors that was not previously on this digest's radar; if it is the same tracked project under confused reporting, no new action is needed. Confirm with BDA/BBCL sources before treating either the acreage or routing as authoritative."],
    ...
    judicial: [
      ...
      ["Siddhartha Vihar Trust — BDA Civic-Amenity-Site Complaint Proceeds; Lokayukta Notice Issued", "Karnataka HC (10 Sept 2026) set aside a trial-court order that had halted a private criminal complaint (filed by Vijayraghava Marathe) over a 2014 BDA civic-amenity-site allotment in south Bengaluru (an 8,125 sq m site in the Banashankari/BTM Layout area, to a trust on whose board members of Congress president Mallikarjun Kharge's family sit — the complaint alleges the trust secured a 50% lease-amount concession by claiming Scheduled Caste status), on the ground that the complainant's affidavit had a curable verification defect. The complainant cured the defect on 10 Sept 2026, and the special court's 18 Sept order held there was no further impediment to proceeding — the court has since issued notice to the Bengaluru Police Commissioner's office and the Karnataka Lokayukta, directing the Lokayukta police to file their response by 6 Oct 2026. This remains a procedural matter — the Court has not made any finding of fraud or wrongdoing.", "A further, lower-severity data point in the pattern of scrutiny on BDA's own land-allotment decisions (alongside Hebbal, D.B. Chandregowda and others already on file) — the Lokayukta-response deadline (6 Oct) is the next concrete date to track; reported factually given its still-procedural (not substantive) posture, and NBR should note the pattern without treating this specific matter as any kind of precedent yet, since no finding on the merits has been made."],
      ["Hebbal KIADB Land Fraud — CBI Probe Ordered", "Karnataka HC (April 2026) ordered a CBI probe into KIADB's 2004 acquisition of 53+ acres in Hebbal and Hebbal Ammanikere villages, calling it a \"monumental fraud committed by state authorities in collusion, collaboration and criminal conspiracy\" with Lakeview Tourism Corporation, a non-existent entity. The Court annulled the land transfer and fined the firm ₹10 lakh (payable to the Army Battle Casualties Welfare Fund); the land, originally for an unbuilt tourism project, has sat unused for two decades, with BMRCL now seeking 45 acres of it for a metro transit hub/depot.", "Another entry in a now-extensive pattern of Karnataka courts unwinding decades-old KIADB/BDA land dealings for fraud or dormancy (alongside NICE/BMICP, Hosahalli, D.B. Chandregowda, the 2001/2004 BDA annulment) — any NBR parcel with a chain-of-title link to a 2000s-era KIADB/BDA transfer to a private entity warrants a fraud/collusion check, not just a paperwork review, given how many such transfers have since been judicially unwound."],
      ["Amit Garg v. Karnataka RERA — Registry Cannot Decide Complaint Maintainability", "Karnataka HC (Justice M. Nagaprasanna) held that the K-RERA Registry has no statutory power to adjudicate whether a homebuyer complaint is maintainable — only Tribunal/Authority members can decide that question, since the Registry's role is purely administrative. The Court quashed an email order by which the Registry had rejected a Bengaluru apartment owner's complaint, calling it \"illegal,\" and restored the complaint for proper adjudication.", "A useful procedural safeguard: any K-RERA complaint against NBR (or filed on NBR's behalf) that was ever summarily rejected by Registry email, rather than decided by the Authority/Tribunal itself, may be vulnerable to being reopened on this ground — legal team should check whether this cuts for or against NBR in any live or past K-RERA matter before relying on a Registry-level rejection as final."],
      ...
      ["DRDO v. Special Land Acquisition Officer — CAIR Acquisition Restored (127 Acres)", "Karnataka HC Division Bench (Justices D.K. Singh and H. Shanthi Bhushan, 21 Sept 2026, with further coverage confirming the figure on 25 Sept) set aside a 2014 single-judge order that had quashed acquisition of 127 acres at Benniganahalli, Bengaluru for DRDO's Centre for Artificial Intelligence and Robotics (CAIR), holding the interests of national security must take precedence over personal rights and that the acquisition served a public purpose connected with national defence, while preserving the landowners' right to lawful compensation.", "A defence-linked public-purpose acquisition was upheld on appeal despite a decade-old adverse ruling — a useful counterweight to the pattern of dormancy/fraud-based quashings already on file, confirming that acquisitions with a clear, high-priority public-purpose justification (here, national security) can survive even a long-pending legal challenge. Not directly relevant to NBR's commercial land dealings, but useful context on how far Karnataka courts will stretch \"public purpose\" when national-security interests are asserted."],
      ["Karnataka Renewable Energy Policy — Land-Use Limits on Self-Acquired Land Struck Down", "Karnataka HC (25 Sept 2026) partially allowed petitions challenging the Karnataka Renewable Energy Policy 2022-27, holding that the state cannot impose prescribed land-use limits on renewable-energy developers who themselves acquire or lease the land for their project — such curbs are arbitrary when applied to land the developer has independently acquired, as opposed to land allotted by the state.", "Not a real-estate ruling, but the underlying principle — that a state policy cannot restrict how a developer uses land it has independently and lawfully acquired — is a useful analogical data point on the limits of Karnataka's land-use-restriction powers generally. Worth keeping on file if NBR's legal team ever needs to argue against a land-use restriction imposed on NBR-owned (rather than government-allotted) land, though the ruling's direct application is limited to the renewable-energy policy context."],
      ["KHB v. Objectors — Suryanagar Phase IV (Bannerghatta Elephant Corridor) Quashed", "Karnataka HC Division Bench (Justices D.K. Singh and H. Shanthi Bhushan, 29 Aug 2026 — newly captured on this tracker) quashed the Karnataka Housing Board's acquisition of 1,938+ acres for the Suryanagar Phase IV layout, holding the land falls within the Karadikkal-Madeshwara elephant corridor and the 268.96 sq km Bannerghatta National Park eco-sensitive zone, and that elephants \"cannot be displaced from their homes or treated as occupants without any rights\" — the Bench held no public purpose, however legitimate, can override environmental conservation. Separately reported: acquisition activity for the same layout has continued on the ground despite the quashing, per local coverage.", "A significant new precedent for any NBR parcel near a designated eco-sensitive zone, wildlife corridor or protected-area buffer (Bannerghatta ESZ or otherwise) — environmental/wildlife-corridor status can defeat even a large-scale (1,938-acre), government-agency-led housing acquisition outright, not merely delay or reduce it. Legal team should map any NBR land bank or prospective parcel against known elephant-corridor and ESZ boundaries before assuming a KHB/BDA-notified layout is a safe acquisition target. The reported on-the-ground continuation despite quashing is also worth noting as an enforcement/compliance-gap data point."],
    ],
    gradeA: [
      ...
      ["8", "Shriram Properties", "Targeting up to ₹4,000 Cr in pre-sales by FY27, with Pune emerging as a fast-growing market alongside Bengaluru, Chennai and Kolkata — context for its ₹600 Cr Yelahanka row-housing JDA (7 acres) already on file. Also holds a ~4-acre outright land purchase on Sarjapur Main Road, South-East Bengaluru (~₹550-600 Cr GDV, ~0.5 msf saleable, announced 16 Feb 2026) — near Whitefield/Varthur/ORR and the upcoming Dommasandra Metro station — not previously captured in this tracker.", "₹4,000 Cr FY27 pre-sales target (multi-city); ₹600 Cr JDA, 7 acres (Yelahanka); ~4-acre / ₹550-600 Cr Sarjapur Main Road purchase", "The Sarjapur Main Road purchase places Shriram directly inside NBR's core corridor alongside Puravankara, Godrej, Assetz, Adarsh and Casagrand — even though the deal itself is several months old, its presence in NBR's home turf is a standing competitive fact worth having on file going forward."],
    ],
    midTier: [
      ...
      ["13", "Birla Estates", "JV with M S Ramaiah Realty LLP for a 52-acre integrated township in Devanahalli (Birla Trimaya, ₹3,000 Cr target) has booked ~₹2,459 Cr across phases (Phase 4 alone ~₹650 Cr, 85%+ sold); its separate JV with Mitsubishi Estate Co. for a Southeast Bengaluru residential project is now confirmed at a ₹560 Cr investment. Parent Aditya Birla Real Estate has separately guided (10 Sept 2026) for ₹10,000-15,000 Cr of new business development at Birla Estates in FY27 — a multi-city target, not Bengaluru-specific, but the largest forward-looking BD figure yet disclosed by this peer.", "Premium residential, new entrant — two large JVs (Ramaiah Realty in Devanahalli; ₹560 Cr Mitsubishi Estate JV in Southeast Bengaluru); ₹10,000-15,000 Cr FY27 multi-city BD target"],
    ...
    recommendations: [
      { head: "Land Acquisition Strategy", color: NAVY, items: [
        "Confirm whether the newly-notified 1,427.34-acre \"Bengaluru Business Corridor\" (Mysuru Road–Hosur Road via Jigani/Bommasandra/Attibele, 5 Sept 2026) is a genuinely distinct southern corridor from the tracked 74-km ex-PRR project or a reporting overlap — this determines whether it opens a new land-acquisition/compensation-opportunity zone worth evaluating.",
        "With the GBA handover now in effect, confirm today that every time-sensitive NBR khata/tax/approval filing is routed to the correct one of the 5 new corporations (Central/North/East/West/South) by micro-market — misrouting during this transition week is the most immediate operational risk.",
        "Karanth Layout's shift from priced-but-unallotted to actual site distribution (31 Aug) makes ₹6,000/sq ft a live North Bengaluru comparable rather than a proposed rate — use it as a current benchmark for any nearby NBR parcel evaluation, and watch for the public-application phase (pending CM approval) as the next site-supply signal.",
      ...
      { head: "Legal & Compliance", color: RED_RISK, items: [
        "The Amit Garg ruling confirms the K-RERA Registry cannot summarily reject a complaint by email — only the Authority/Tribunal can decide maintainability; check whether any NBR-related K-RERA matter (as respondent or complainant) was ever closed at Registry level rather than by the Authority, since it may now be reopenable.",
        ...
        "The Hebbal KIADB fraud ruling (CBI probe, transfer annulled) extends this same judicial-scrutiny pattern to outright fraud/collusion, not just dormancy — any NBR chain-of-title link to a 2000s-era KIADB/BDA transfer to a private entity should be checked for similar red flags, not assumed clean on paperwork alone.",
        "The Sulikere transport-hub-to-residential CLU episode is a reminder to verify a BDA site's ORIGINAL notified purpose and approval trail, not just its current land-use classification — a residential site's status may itself rest on an unauthorised conversion that could later be challenged.",
      ]},
  ...
  layer2: {
    regional: [
      ...
      ["Telangana / Hyderabad", "Telangana HC (1 Sept 2026) put HYDRAA Commissioner Ranganath's removal ON HOLD, staying a single judge's order (issued in a Shantha Sriram Constructions contempt petition tied to the Lothukunta demolition dispute) that would have required the state government to remove him from post — the underlying contempt matter itself remains unresolved. This layers onto the Gachibowli building-collapse safety-demolition drive, the ₹72 Cr HYDRAA funding tranche, the G.O.Ms.No.218 HMDA TDR geographic-flexibility amendment, TG RERA's realtor penalties, the Malkajgiri contempt proceeding, and five IAS/IPS contempt notices already on file.", "The removal-order stay is a favourable near-term signal for HYDRAA's institutional continuity under Ranganath, but the underlying Lothukunta-linked contempt proceeding is still live — NBR should treat HYDRAA's enforcement leadership as stable for now but not treat this as a final resolution of the legal exposure around it."],
      ["Andhra Pradesh / Amaravati", "Andhra Pradesh has ordered a substantial fresh second-phase land-pooling round for Amaravati — 20,494 acres (16,562.56 acres patta land, 104.01 acres assigned land, 3,828.30 acres government land) across 7 villages (Vaikuntapuram, Pedamadduru, Endrai, Karlapudi, Vaddamanu, Harischandrapuram, Pedaparimi) — for an expanded International Sports City (now 2,500 acres, up from an initial 70), a greenfield international airport, a new railway station and the Inner Ring Road. Officials have now framed the total Phase II ask more broadly at 40,000-45,000 acres (State Municipal Administration Minister P. Narayana: ~5,000 acres for the airport, 2,500 for smart industries, 2,500 for a sports city — ~10,000 acres for these flagship projects, with the Minister claiming only ~25% of the full 45,000 acres will actually be used for public purposes). Pedamaddur's own pooling has progressed to ~70.66-75% (up from the figure previously on file). Farmers, activists and political groups have raised concerns about fertile-land loss, inadequate compensation and — notably — that Phase 1's pooled land has still not been fully developed/serviced, meaning the government has not yet fulfilled its commitments to the original 2014-19 contributors before asking for more land. This adds to the Supreme Court's 14 Aug decision declining to interfere with the quashing of the criminal case against CM Naidu, the SIPB's ₹2,08,406 Cr investment approval and the Seed Access Road launch already on file.", "The 40,000-45,000-acre Phase II framing (vs. the ~34,000 acres pooled in 2014-19) confirms Amaravati's capital build-out is scaling up materially. The unfulfilled-Phase-1-commitments critique is a genuinely new risk signal worth tracking: it suggests AP's execution capacity on SERVICING pooled land (not just acquiring it) has lagged, a relevant caution if NBR ever benchmarks AP's land-delivery reliability for a South India footprint beyond Karnataka. Still not an actionable NBR opportunity given no direct Karnataka/Bengaluru nexus."],
      ["Kerala", "Kerala's \"Land Reforms 2.0\" review (already on file, and already drawing controversy over whether it favours farmers or encroachers/resort operators) has now moved forward on two fronts: separately from the 17 Aug 2026 Vizhinjam-linked acquisition-speedup announcement already on file, State Revenue Minister A.P. Anilkumar stated (19 Sept 2026) the government will systematically ease land-ceiling and other regulatory hurdles to unlock parcels for industrial and tourism investment; and the promised expert committee has now actually been constituted (24 Sept 2026, government order) — a five-member panel chaired by former Land Revenue Commissioner A.T. James — tasked with reviewing the Kerala Land Reforms Act, 1963 and related statutes (ceiling laws, tenancy rules, acquisition/conversion/mutation procedures, land-records digitisation) and submitting revision recommendations.", "The committee's formation, with a named chair and a concrete scope, converts \"Land Reforms 2.0\" from an announced intention into an active review process — NBR's legal team should now identify and track this committee (A.T. James panel) directly as the authoritative source for any eventual ceiling/conversion-rule change, rather than relying on ministerial statements alone. The pro-industry framing (Minister Anilkumar's 19 Sept remarks) is a modestly positive signal for any eventual Kerala market-entry, but the committee's own recommendations — not the announcement — will determine the actual outcome and its pro-farmer vs. pro-investment balance."],
    ],
    deals: [
    ...
    recommendations: [
      { head: "Regional Positioning", color: NAVY, items: [
        "Amaravati's fresh 20,494-acre second-phase land-pooling order is the largest single scale-up flagged in this digest to date, approaching the original 2014-19 pooling phase's ~34,000-acre scope — a stronger signal of AP's genuine execution capacity worth revisiting if a South India footprint beyond Karnataka is ever considered, though still not actionable for NBR today.",
      ...
      { head: "Legal Watch", color: RED_RISK, items: [
        "The Madras HC's Balakrishnan v. TNRERA ruling confirms TNRERA registration does not settle disputed land title — if NBR ever pursues a Chennai project, independent title diligence (not just confirming TNRERA registration) remains essential, since a registered project can still carry a live civil-court title dispute.",
  ...
  sources: [
    ...
    "ConstroFacilitator / Asianet Newsable — BDA Dr K Shivaram Karanth Layout site-allotment-start (31 Aug 2026) coverage",
    "Deccan Herald / OneIndia — Andhra Pradesh Amaravati 20,494-acre second-phase land-pooling order coverage",
    "The News Minute / BookNewProperty — GBA-replaces-BBMP (2 Sept 2026) handover-day leadership and 5-corporation-structure coverage",
    "LiveLaw.in / Verdictum — Amit Garg v. Karnataka RERA (Registry maintainability-adjudication) ruling coverage",
    ...
    "Deccan Herald / Organiser / The420.in — Hebbal KIADB land-fraud CBI-probe coverage",
    "Vijay Karnataka / UrbanAcres — \"Bengaluru Business Corridor\" (South) / Peripheral Ring Road-2 final-notification (1,427.34 acres, 5 Sept 2026) coverage",
    "AngelOne / ConstructionWorld / Deccan Herald — Godrej Properties 26-acre Sarjapur Road land-purchase (Oct 2025) coverage",
    "Deccan Herald — Sulikere transport-hub-to-residential CLU (17.49 acres, Mysuru Road) coverage",
    "India Legal / Law Trend — Karnataka HC ruling on Siddhartha Vihar Trust BDA civic-amenity-site complaint coverage",
    "The Hans India / KannadaTick / eauctionsindia.com — Karnataka HC order permitting BDA Shivaram Karanth Layout public applications (2,815 sites, deadline 15 Oct 2026) coverage",
    "Deccan Herald — BDA Karanth Layout 60:40 landowner-allotment objections-window coverage",
    "Bar and Bench / Verdictum / Moneylife — Madras HC N. Balakrishnan v. TNRERA (title-dispute jurisdiction) ruling coverage",
    "Business Standard / Outlook Business / ANI — Puravankara Delhi-NCR maiden-entry Greater Noida land-deal coverage",
    "The South First / Telangana Today / greatandhra.com — Amaravati Phase II 40,000-45,000-acre land-pooling scope and Phase-1-commitments-unfulfilled concerns coverage",
    ...
    "LiveLaw / Bar and Bench / LawChakra — Karnataka HC DRDO/CAIR (Benniganahalli) land-acquisition-restoration ruling coverage",
    "LiveLaw / Bar and Bench / Law Trend — Karnataka HC Bannerghatta elephant-corridor (Suryanagar Phase IV, KHB) land-acquisition-quashing coverage",
    "Green Minute — Suryanagar Phase IV on-the-ground acquisition-continuation-despite-quashing coverage",
    "NammaWard — Dr K Shivaram Karanth Layout administrative-fee negotiation (₹54,000 to ~₹12,000, 30×40 site) coverage",
    "UNI India / The Statesman — Kerala land-law easing (Minister A.P. Anilkumar, 19 Sept 2026) coverage",
    "Keraleeyam / Kerala Government Order — Kerala \"Land Reforms 2.0\" five-member expert committee (A.T. James, 24 Sept 2026) constitution coverage",
    "Business Standard — Birla Estates FY27 ₹10,000-15,000 Cr business-development target coverage",
    "Organiser / India Legal / Law Trend — Siddhartha Vihar Trust Lokayukta-notice and 6 Oct 2026 response-deadline coverage",
    "GBA (Greater Bengaluru Authority) official X/Twitter — revised SIR 2026 electoral-roll schedule coverage",
    "Deccan Herald — Karnataka HC DRDO/CAIR 127-acre Benniganahalli acquisition-restoration coverage",
    "Mercom India / Kalpa Power — Karnataka HC Renewable Energy Policy 2022-27 land-use-limits ruling coverage",
  ],
};
