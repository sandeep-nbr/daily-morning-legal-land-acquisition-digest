...
const CONTENT = {
  ...
  editionNo: "Vol. I — Edition 024",

  execSummary: [
    { tag: "HIGH", color: AMBER_WATCH, text: "Brigade Enterprises' Q1 FY27 results (approved 13 Aug) correct yesterday's expected read: profit grew 33% YoY (₹200.41 Cr) and average realisation rose 21% YoY (₹14,256/sq ft), but residential pre-sales VALUE fell 5.09% YoY (₹1,061 Cr) and pre-sales VOLUME fell 22.1% YoY — mirroring Prestige's decline rather than confirming Godrej/Sobha/Puravankara's growth. This earnings season is now a genuine 3-vs-2 split, not a single-outlier story: three Grade A peers grew pre-sales, two (Prestige, Brigade) saw volume declines even as realisation and profit both rose for them." },
    { tag: "INFO", color: NAVY, text: "Bengaluru Business Corridor Phase 1 land acquisition has progressed to ~83% complete (523 of 665 acres, per BBCL), up from the ~78% figure previously on file; still no BDA response to the Governor petition or the Madavara High Court petition." },
    { tag: "INFO", color: NAVY, text: "Brigade's balance sheet remains conservative despite the pre-sales dip: net debt ₹2,218 Cr, net debt-to-equity 0.26x, and a 543-acre land bank (₹4,672 Cr, ₹3,734 Cr already paid) — costs fell 17.75% YoY on lower land-purchase and approval charges." },
    { tag: "INFO", color: NAVY, text: "A quiet day otherwise: no new NBR-specific news, fresh mid-tier Bengaluru land deal, new Karnataka HC ruling, or other Layer 2 regional development since yesterday." },
  ],
