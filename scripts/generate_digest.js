...
const CONTENT = {
  ...
  editionNo: "Vol. I — Edition 028",

  execSummary: [
    { tag: "HIGH", color: RED_RISK, text: "The B-Khata→A-Khata 2% conversion window closes in just 5 days (23 Aug) — only ~60,000 of the roughly 7 lakh eligible B-register properties across Bengaluru have been converted so far, and no extension has been signalled. From 24 Aug the fee reverts to 5% of guidance value, a multi-lakh cost difference on a typical site." },
    { tag: "WATCH", color: AMBER_WATCH, text: "Telangana has released the first ₹72 Cr tranche of a ₹200 Cr HYDRAA budget allocation (₹50 Cr Budget Estimate + ₹22 Cr from MA&UD) for office, vehicles and past-demolition costs — even as the agency remains under the Telangana HC's demolition restraint pending a formal SOP. Commissioner Ranganath has separately defended himself publicly, alleging land mafias misled courts, citing the Lothukunta case (Shantha Sriram; ~₹10,000 Cr government land; heritage-rock blasting) as an example of the encroachment HYDRAA has been fighting." },
    { tag: "INFO", color: NAVY, text: "No public BDA response yet to the BBC Governor petition or the Madavara High Court petition; Phase 1 land acquisition remains at ~83% complete. A quiet day otherwise: no new NBR-specific news, fresh Grade A/mid-tier Bengaluru land deal, or new Karnataka HC ruling since yesterday." },
  ],
  ...
  layer1: {
    regulatory: [
      ...
      ["B-Khata → A-Khata Window", "The 2%-of-guidance-value conversion window (15 May – 23 Aug 2026) now closes in just 5 days, with no extension signalled. Only ~60,000 of the roughly 7 lakh eligible B-register properties across Bengaluru have been converted so far — a small fraction of the pool this window was designed to clear. From 24 Aug the fee reverts to the standard 5%.", "This is now an urgent, not near-term, legal-team deadline — fast-track any pending B-Khata conversion filings for NBR-held or under-acquisition parcels this week; missing the window means paying the full 5% rate (a multi-lakh cost difference on a typical site) with no indication of when or whether a similar reduced-rate window will recur."],
