...
const CONTENT = {
  ...
  editionNo: "Vol. I — Edition 036",

  execSummary: [
    { tag: "HIGH", color: RED_RISK, text: "TOMORROW (2 Sept) is the confirmed administrative handover date on which the Greater Bengaluru Authority formally replaces BBMP, with Maheshwar Rao taking over as Chief Commissioner. This is the operative near-term date for khata/tax/approval filings — confirm all time-sensitive NBR filings are routed correctly as the handover takes effect, while elected local governance remains unsettled until at least the 31 December 2026 Supreme Court deadline." },
    { tag: "INFO", color: NAVY, text: "A quiet day otherwise: no new Grade A/mid-tier Bengaluru land deal since Puravankara's Electronic City JDA and Brigade's Whitefield buy, no fresh Karnataka HC land ruling since the Lalitha S. GST-compensation decision, no public BDA response to the BBC Governor petition, and no developments in TNRERA, HYDRAA, Amaravati or Kerala beyond what is already on file. No new NBR-specific news." },
  ],
  ...
  layer1: {
    ...
    recommendations: [
      { head: "Land Acquisition Strategy", color: NAVY, items: [
        "With the GBA administrative handover taking effect tomorrow (2 Sept), confirm today that every time-sensitive NBR khata/tax/approval filing is correctly routed to the new GBA/five-corporation structure from day one — any filing caught mid-transition risks delay while the new administrative machinery settles in.",
  ...
  sources: [
    ...
    "The News Minute / BookNewProperty / Urban Acres — GBA-replaces-BBMP (2 Sept 2026) handover-eve coverage",
