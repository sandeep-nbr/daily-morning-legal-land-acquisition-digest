...
const CONTENT = {
  ...
  editionNo: "Vol. I — Edition 018",

  execSummary: [
    { tag: "WATCH", color: AMBER_WATCH, text: "Andhra Pradesh has set its first firm capital-delivery target: Amaravati's Phase 1 is now due for completion by August 2028, with APCRDA running Gram Sabhas across capital-region villages (since 4 Aug) to finalise the Master Plan and village-road network ahead of a government-set land-pooling completion timeline." },
    { tag: "WATCH", color: AMBER_WATCH, text: "Telangana's HYDRAA saga has widened beyond the commissioner-removal order: the High Court's order rests on 63 pending contempt petitions against Commissioner Ranganath, and a separate Section 22A land-freeze designation is now stalling property transactions and drawing builder/developer concern across Hyderabad and neighbouring districts." },
    { tag: "INFO", color: NAVY, text: "Kerala's 2026-27 Budget has formalised \"Land Reforms 2.0\" — a comprehensive review of the Land Reforms Act, 1963 and related statutes (digitisation, procedural simplification, dispute resolution) via a high-level expert committee due to report within 6 months; opposition has flagged concern over possible dilution of pro-farmer provisions." },
    { tag: "INFO", color: NAVY, text: "A quiet day on the core Bengaluru front: no new NBR-specific news, Karnataka guidance-value notification, fresh Grade A/mid-tier land deal, or new Karnataka HC land ruling since yesterday. The B-Khata→A-Khata window closes in just over two weeks (23 Aug)." },
  ],
  ...
  layer1: {
    ...
    recommendations: [
      ...
      { head: "Competitive Positioning", color: GREEN_POS, items: [
        "Sumadhura's second East Bengaluru land move in two weeks (₹3,500 Cr / 17-acre Whitefield-Kannamangala JDA, on top of its ~₹5,000 Cr 3-year investment plan) confirms it has stepped up from the smaller-launch pattern tracked earlier — reassess whether NBR's mid-tier competitive tiering still reflects Sumadhura's actual scale.",
        "Puravankara's ₹1,300 Cr Hennur Road JDA remains the most recent of its sixth-plus fresh Bengaluru land moves tracked in this digest — still the benchmark for the most consistently acquisitive Grade A peer.",
  ...
  layer2: {
    regional: [
      ["Tamil Nadu / Chennai", "TNRERA has been thrown into a governance vacuum: its chairperson and two members resigned, and the state government has installed a three-member interim panel (K. Phanindra Reddy — retired IAS, chairperson; A. Nazir Ahamed — retired district judge; Reeta Harish Thakkar — retired IAS) to run the Authority for 6 months from 14 Jul 2026. This sits alongside the Jan 2026 guideline-value revision (OMR/ECR/GST Road corridors) and 11% all-in stamp duty + registration already on file.", "A regulator running on an interim panel — even a credentialed one — is a genuine governance-continuity risk if NBR ever pursues a Chennai entry or JV; treat any TNRERA approval or registration sought during this 6-month window as subject to extra follow-up once permanent leadership is restored."],
      ["Telangana / Hyderabad", "The Telangana HC's 1 Aug 2026 HYDRAA-commissioner removal order is now shown to rest on 63 pending contempt-of-court petitions against Ranganath, against a backdrop of continued public protests in his support and a CM pledge that the anti-encroachment drive continues regardless. Separately, and distinctly, a Section 22A land-freeze designation (Registration Act) is now stalling property transactions and drawing builder/developer concern for lack of prior notice across Hyderabad and neighbouring districts — layering onto the HYDRAA-land-monetisation (HMDA/TGIIC auction) plan already on file.", "The Section 22A designations are a fresh, distinct diligence risk beyond the HYDRAA leadership question — any Hyderabad parcel diligence must now separately check Section 22A flag status, since a flagged parcel can have registration/transfer stalled without prior notice to the owner."],
      ...
      ["Kerala", "Kerala's 2026-27 Budget has formalised the previously reported land-law committee proposal into a named initiative — \"Land Reforms 2.0\" — a comprehensive review of the Kerala Land Reforms Act, 1963 and related statutes covering digitisation, procedural simplification and dispute resolution, via a high-level expert committee due to report within 6 months; opposition parties have welcomed the concept but flagged concern over possible dilution of pro-farmer provisions.", "Land Reforms 2.0 is still a review-stage initiative, not yet actionable, but the named committee and 6-month reporting deadline give NBR's legal team a concrete timeline to track for potential impact on assignment-land conversions, if Kerala is ever on the roadmap."],
    ],
    deals: [
    ...
    recommendations: [
      { head: "Regional Positioning", color: NAVY, items: [
        "Section 22A land-freeze designations are a fresh, distinct Hyderabad diligence risk beyond the HYDRAA leadership question — any Hyderabad parcel diligence should now separately check Section 22A flag status given builders' reports of stalled transactions without prior notice.",
        ...
        "The HYDRAA-commissioner removal order's basis (63 pending contempt petitions) and continued public pushback both suggest a protracted resolution — treat Hyderabad's regulatory posture as unsettled rather than assume either a softer or harsher outcome.",
      ]},
      { head: "Legal Watch", color: RED_RISK, items: [
        "Kerala's \"Land Reforms 2.0\" now has a named committee and 6-month reporting deadline — track its recommendations given potential impact on assignment-land conversion rules in that state.",
        "TNRERA is still operating under a 6-month interim panel (from 14 Jul 2026) after its chairperson and two members resigned — treat any TNRERA approval or registration sought during this window as subject to extra follow-up once permanent leadership is restored, if NBR ever pursues a Chennai entry or JV.",
