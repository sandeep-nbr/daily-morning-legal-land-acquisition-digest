...
const CONTENT = {
  ...
  editionNo: "Vol. I — Edition 016",

  execSummary: [
    { tag: "HIGH", color: GREEN_POS, text: "BDA has revised the Bengaluru Business Corridor's land-use plan — the road corridor stays at 65m (matching the Bengaluru-Mysuru highway width) while a 35m strip is being handed BACK to farmers rather than acquired for commercial use, effectively shrinking the total acquisition footprint. Public objections are invited over a 2-month window." },
    { tag: "WATCH", color: AMBER_WATCH, text: "Puravankara has signed a further JDA — ₹1,300 Cr, 4 acres on Hennur Road, North Bengaluru, 0.84 msf, launch within 12 months — its sixth-plus fresh Bengaluru land move flagged in this digest, reinforcing it as the most consistently acquisitive Grade A peer tracked." },
    { tag: "INFO", color: NAVY, text: "Karnataka HC has upheld an order directing a Bengaluru developer to refund ~₹1.77 lakh with interest to homebuyers — a small case, but a continued data point on active RERA refund enforcement." },
    { tag: "INFO", color: NAVY, text: "No new NBR-specific news, Karnataka guidance-value gazette notification, or fresh mid-tier land deals since yesterday; the B-Khata→A-Khata window closes in just over two weeks (23 Aug)." },
  ],
  ...
  layer1: {
    ...
    recommendations: [
      { head: "Land Acquisition Strategy", color: NAVY, items: [
        "BDA's BBC land-use revision (65m road, 35m strip returned to farmers) is the strongest pro-landowner signal yet on this corridor — re-run BBC-adjacent parcel economics assuming a narrower final acquisition footprint, but hold off treating it as final until the 2-month objection window closes and the 1,000+ objections already filed are resolved.",
        "Casagrand's Sarjapur Road luxury launch remains the fourth-plus Grade A/mid-tier entrant flagged inside NBR's home corridor in recent weeks (after Puravankara, Godrej, Adarsh, Assetz) — this pace of entry should continue to factor into near-term pricing and launch-timing decisions on any NBR Sarjapur project.",
      ...
      { head: "Legal & Compliance", color: RED_RISK, items: [
        ...
        "The K-RERA refund pattern now spans claims from ₹1.77 lakh to ₹79.84 lakh, all upheld on appeal — budget for refund/interest exposure as a near-certain outcome once any K-RERA order is upheld, rather than assuming smaller claims will lapse.",
      ...
      { head: "Competitive Positioning", color: GREEN_POS, items: [
        "Puravankara's new ₹1,300 Cr Hennur Road JDA is its sixth-plus fresh Bengaluru land move tracked in this digest — reconfirm it as the most consistently acquisitive Grade A peer when benchmarking NBR's own land-acquisition cadence.",
