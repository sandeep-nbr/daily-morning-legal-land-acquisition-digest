...
// ---------------------------------------------------------------------------
const CONTENT = {
  dateLabel: "Monday, 10 August 2026",
  editionNo: "Vol. I — Edition 020",

  execSummary: [
    { tag: "HIGH", color: RED_RISK, text: "BBC land acquisition faces its most direct legal challenge yet: the PRR Farmers and Site Owners Association has petitioned the Governor to scrap the project, arguing the original June 2007 acquisition notification lapsed under the old 1894 Act for want of an award within 5 years — the same dormancy doctrine that has repeatedly favoured landowners in Karnataka HC rulings tracked in this digest (NICE/BMICP, Hosahalli, 2001/2004 BDA annulment). Separately, 250+ farmers/landowners have filed a High Court petition specifically over the 3.8 km Madavara-intersection stretch." },
    { tag: "INFO", color: NAVY, text: "Karnataka's proposed 10-15% guidance-value hike remains un-gazetted as of today — still pending formal notification nearly four months after the April 2026 announcement; current rates continue to apply." },
    { tag: "INFO", color: NAVY, text: "Tamil Nadu's registration department continues rolling out \"STAR 3.0\" (Simplified and Transparent Administration of Registration) alongside the Three-Account System and interim-panel governance at TNRERA already on file." },
    { tag: "INFO", color: NAVY, text: "A quiet day otherwise: no new NBR-specific news, fresh Grade A/mid-tier Bengaluru land deal, or new Karnataka HC ruling since yesterday." },
  ],
