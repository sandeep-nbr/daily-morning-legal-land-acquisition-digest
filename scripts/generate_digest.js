...
const CONTENT = {
  ...
  editionNo: "Vol. I — Edition 009",

  execSummary: [
    { tag: "HIGH", color: RED_RISK, text: "Karnataka HC (29 Jul) upheld the quashing of KIADB's land acquisition for the NICE/Bangalore-Mysuru Infrastructure Corridor project, dismissing NICE's appeal — the Division Bench cited encroachment allegations on lakes/private land and found affected farmers had not received adequate compensation despite the toll operator's substantial revenue. This corrects our earlier file note that NICE had simply withdrawn its case; it in fact pursued and lost an appeal." },
    { tag: "WATCH", color: AMBER_WATCH, text: "Telangana HC has gone further than a warning — it directly asked the Chief Secretary to REPLACE HYDRAA Commissioner Ranganath, who is publicly defending his 2-year tenure by citing ~₹1.5 lakh Cr in reclaimed public assets and framing the 63 contempt cases against him as filed by displaced encroachers." },
    { tag: "WATCH", color: GREEN_POS, text: "Adarsh Developers has raised ₹1,600 Cr+ in funding to drive a 10 msf residential portfolio, and Sumadhura is going vertical with a ₹250 Cr, 297-unit twin-tower (28-floor) project — both signal accelerating mid-tier scale-up in Bengaluru." },
    { tag: "INFO", color: NAVY, text: "The Birla Estates–Mitsubishi Estate JV for Southeast Bengaluru is now confirmed at a ₹560 Cr investment, adding a hard figure to the partnership flagged earlier this week." },
    { tag: "INFO", color: NAVY, text: "No new BBC court-filing updates, K-RERA enforcement orders, or guidance-value gazette notification since yesterday; the BDA e-auction bidding rounds (28-31 Jul) and B-Khata window (closing 23 Aug) both remain live and unchanged." },
  ],
  ...
  layer1: {
    ...
    recommendations: [
      ...
      { head: "Legal & Compliance", color: RED_RISK, items: [
        "The NICE/BMICP ruling (29 Jul) and the Thalaghattapura BMICP quashings together show a documented pattern of Karnataka courts striking down old, dormant land acquisitions on grounds of undue delay and inadequate compensation — extend legal-team review to any NBR parcel history involving a decades-old, never-executed acquisition notation, since this pattern strengthens landowners' hand against such acquisitions.",
  ...
  layer2: {
    regional: [
      ...
      ["Telangana / Hyderabad", "The Telangana HC has directly asked the Chief Secretary to REPLACE HYDRAA Commissioner Ranganath — not merely warned him — while Ranganath publicly defends his 2-year tenure by citing ~₹1.5 lakh Cr in reclaimed public assets and framing the 63 pending contempt cases as filed by displaced encroachers; the HC has separately ruled GHMC cannot acquire private land without owner consent.", "A direct judicial call for a sitting commissioner's replacement is a significant escalation beyond a warning — NBR's Hyderabad land diligence should treat HYDRAA's leadership and enforcement posture as institutionally unsettled right now, independently verifying any parcel's encroachment/dispute history rather than relying on either side's public framing."],
