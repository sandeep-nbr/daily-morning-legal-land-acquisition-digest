...
const CONTENT = {
  ...
  editionNo: "Vol. I — Edition 022",

  execSummary: [
    { tag: "WATCH", color: AMBER_WATCH, text: "Telangana's government has decided to formally challenge the Telangana HC's HYDRAA-commissioner removal order, with CM Revanth Reddy vowing a legal fight — most likely an appeal to a Division Bench or the Supreme Court — arguing the order encroaches on the executive's Article 311 power over officer transfers/removals, not just a contempt-punishment question." },
    { tag: "WATCH", color: AMBER_WATCH, text: "The Grade A Q1 FY27 earnings picture is now fuller: Sobha posted record sales (+76% YoY to ₹3,656 Cr, net cash positive) and Puravankara posted pre-sales +28% YoY (₹1,439 Cr) plus 4 fresh land deals (~41.93 acres, ₹5,200 Cr GDV) — both strong growth, reinforcing that Prestige's ~46% pre-sales decline (flagged yesterday) looks like a company-specific/high-base effect rather than a sector-wide slowdown. Brigade's results (due 13 Aug) remain the last data point to confirm this." },
    { tag: "INFO", color: NAVY, text: "No public BDA response yet to the Governor petition or the Madavara High Court petition on the Bengaluru Business Corridor; both remain pending." },
    { tag: "INFO", color: NAVY, text: "A quiet day otherwise: no new NBR-specific news, fresh mid-tier Bengaluru land deal, or new Karnataka HC ruling since yesterday." },
  ],
  ...
  layer1: {
    ...
    gradeA: [
      ...
      ["2", "Brigade Group", "Outright purchase of a 2-acre parcel on Kanakapura Road, South Bengaluru (~₹400 Cr GDV) — its third distinct Bengaluru land move on file, alongside the Whitefield-Hoskote mixed-use development (₹5,200 Cr GDV) and Malur plotted development, plus the Prestige JV on Old Madras Road and Gunjur JDA. Q1 FY27 results are due 13 Aug 2026 (alongside its 31st AGM) — the next earnings data point to watch after Godrej's growth and Prestige's decline this same season.", "8+ deals / ~123 acres FY26; Whitefield-Hoskote alone valued at ₹5,200 Cr GDV; new Kanakapura Road parcel ~₹400 Cr GDV; Q1 FY27 results due 13 Aug", "Brigade is now spreading bets across South (Kanakapura Road), East (Whitefield-Hoskote) and outer (Malur) Bengaluru simultaneously — a broader geographic spread than most peers tracked; its 13 Aug results will be the third Grade A earnings data point this season and worth checking against the Godrej/Prestige divergence."],
  ...
  layer2: {
    regional: [
      ...
      ["Telangana / Hyderabad", "The HYDRAA fight has escalated to an executive-vs-judiciary standoff: the Telangana government, led by CM Revanth Reddy, has decided to formally challenge the HC's commissioner-removal order (Justice Jukanti Anil Kumar, 27 Jul 2026, citing 63 pending contempt petitions), most likely via appeal to a Division Bench or the Supreme Court, arguing the order improperly overrides the executive's Article 311 power over officer transfers/removals. This layers onto the contempt notices already issued to five senior IAS/IPS officers (incl. Special Chief Secretary Jayesh Ranjan), the Sangareddy 861-acre reclamation, and the Section 22A land-freeze designations already on file.", "A government formally contesting a court-ordered removal on separation-of-powers grounds signals this dispute will run for months, not resolve quickly — NBR should not assume any near-term change in HYDRAA's enforcement posture or leadership either way, and should continue treating Section 22A flag status as an independent Hyderabad diligence item regardless of how the appeal plays out."],
