...
const CONTENT = {
  ...
  editionNo: "Vol. I — Edition 027",

  execSummary: [
    { tag: "HIGH", color: RED_RISK, text: "Telangana HC has restrained HYDRAA from carrying out demolitions in Hyderabad's city and municipal areas — except for encroachments on river bodies, nalas and public roads — until it places a documented Standard Operating Procedure before the court, with Justice B. Vijaysen Reddy citing repeated violations of earlier orders and the total absence of any recorded demolition SOP after hearing hundreds of related cases." },
    { tag: "WATCH", color: AMBER_WATCH, text: "Karnataka HC has stayed a government SIT probe into alleged encroachment of 290+ acres of gomala (grazing) land by a trust linked to the Art of Living Foundation, holding that the mandatory joint survey under the Karnataka Land Revenue Act, 1964 was not conducted before authorities concluded encroachment had occurred — reinforcing that procedural compliance, not just factual encroachment, determines whether a government-land action survives judicial review. Next hearing today." },
    { tag: "INFO", color: NAVY, text: "Andhra Pradesh's State Investment Promotion Board approved ₹2,08,406 Cr in investment proposals across 25 projects (11 Aug), expected to generate 21,627 direct jobs — a significant macro-economic signal for the state." },
    { tag: "INFO", color: NAVY, text: "No public BDA response yet to the BBC Governor petition or the Madavara High Court petition; Phase 1 land acquisition remains at ~83% complete. Otherwise quiet: no new NBR-specific news or fresh Grade A/mid-tier Bengaluru land deal." },
  ],
  ...
  layer2: {
    regional: [
      ...
      ["Telangana / Hyderabad", "The Telangana HC has escalated well beyond the commissioner-removal dispute: Justice B. Vijaysen Reddy has restrained HYDRAA from carrying out ANY demolitions in Hyderabad's city and municipal areas — except encroachments on river bodies, nalas and public roads — until it places a documented SOP before the court, citing repeated violations of earlier orders and no recorded procedure across hundreds of related cases. This layers onto the removal-order appeal, the Malkajgiri contempt proceeding, five IAS/IPS contempt notices, and the district-level push for statewide HYDRAA expansion already on file.", "This is the broadest operational curb on HYDRAA flagged in this digest to date — a blanket demolition restraint (not just a case-specific stay) pending a formal SOP. NBR should treat any active or threatened HYDRAA enforcement action on a Hyderabad parcel as likely paused for now, but the underlying encroachment risk itself is unchanged and will resume once an SOP is filed."],
      ["Andhra Pradesh / Amaravati", "Andhra Pradesh's State Investment Promotion Board (chaired by CM Chandrababu Naidu) approved ₹2,08,406 Cr in investment proposals across 25 projects (11 Aug), expected to generate 21,627 direct jobs — a significant macro-economic signal alongside the Amaravati Seed Access Road (E3) launch, August 2028 Phase 1 completion target, and the 20,494-acre acquisition breakdown already on file.", "A ₹2+ lakh Cr investment approval is a strong confidence signal for Andhra Pradesh's broader economic trajectory, not specific to Amaravati's capital build-out — useful macro context if AP market entry is ever revisited, but track which of the 25 projects (if any) are capital-region-linked before treating this as an Amaravati-specific catalyst."],
