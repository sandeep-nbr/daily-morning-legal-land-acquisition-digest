...
const CONTENT = {
  ...
  editionNo: "Vol. I — Edition 021",

  execSummary: [
    { tag: "WATCH", color: AMBER_WATCH, text: "Prestige Estates' Q1 FY27 results reveal a sharp divergence from Godrej's strong quarter flagged 9 Aug: residential pre-sales fell ~46% YoY to ₹6,579.3 Cr (against a high ₹12,126.4 Cr Q1 FY26 base), and net profit declined to ₹236 Cr from ₹290 Cr — even as revenue (+16% to ₹2,675 Cr) and collections (+6% to ₹4,802.2 Cr) both grew. Brigade Enterprises reports its own Q1 FY27 results on 13 Aug, the next data point to watch in this same earnings season." },
    { tag: "INFO", color: NAVY, text: "No public BDA response yet to yesterday's Governor petition or the Madavara High Court petition on the Bengaluru Business Corridor; both remain pending." },
    { tag: "INFO", color: NAVY, text: "Karnataka's proposed 10-15% guidance-value hike remains un-gazetted; current rates continue to apply." },
    { tag: "INFO", color: NAVY, text: "A quiet day otherwise: no new NBR-specific news, fresh mid-tier Bengaluru land deal, new Karnataka HC ruling, or Layer 2 regional development since yesterday." },
  ],
  ...
  layer1: {
    ...
    recommendations: [
      ...
      { head: "Competitive Positioning", color: GREEN_POS, items: [
        "This earnings season is producing a genuine Grade A divergence — Godrej's Q1 FY27 bookings grew 22% YoY while Prestige's fell ~46% YoY against an unusually high prior-year base — treat this as two data points on a spectrum, not yet a sector-wide trend; Brigade's 13 Aug results will be the tie-breaker worth checking before drawing conclusions about broader Bengaluru demand.",
        ...
        "Both Godrej (-42% YoY) and Prestige (profit down to ₹236 Cr from ₹290 Cr) show declining profit even where bookings/revenue grew — a possible early margin-pressure signal across the Grade A tier worth watching as Brigade's results land, since rising land/construction costs outpacing price realisation would affect NBR's own margin planning too.",
      ]},
    ],
  },
