...
const CONTENT = {
  ...
  editionNo: "Vol. I — Edition 003",

  execSummary: [
    { tag: "HIGH", color: RED_RISK, text: "Puravankara signed a JDA for a 6.4-acre parcel in Sarjapur (₹1,000 Cr revenue potential, 0.8 msf saleable) — a Grade A peer now developing inside NBR's own home corridor, not just its periphery." },
    { tag: "HIGH", color: AMBER_WATCH, text: "BDA's Premium Sites e-Auction 2026 timeline is now fully clear: interest/registration closes 27 Jul 5 PM (EMD ₹4L/site), live bidding runs through 31 Jul 5 PM. One week left end-to-end for NBR to act." },
    { tag: "WATCH", color: GREEN_POS, text: "BDA has issued its first Bengaluru Business Corridor compensation awards (~100 acres), breaking a years-long deadlock — officials say the pace of awards will now accelerate, which should firm up the corridor-adjacent price-appreciation thesis sooner than expected." },
    { tag: "WATCH", color: AMBER_WATCH, text: "The Greater Bengaluru Authority is clearing a ₹437 Cr unpaid-dues backlog and merging the five corporations' databases ahead of GBA elections due by August 2026 (the first municipal poll in 11 years) — a live window in which khata/tax record continuity needs active verification, not assumption." },
    { tag: "INFO", color: NAVY, text: "Karnataka HC's contrasting rulings this month — Hosahalli acquisition quashed for fraud vs. the 516-acre Bidadi township acquisition upheld (PIL dismissed, no procedural violations found) — underline that clean statutory process, not just \"finality,\" is what survives judicial review." },
  ],
  ...
  layer1: {
    regulatory: [
      ...
      ["BBMP → GBA Transition", "BBMP was officially dissolved in September 2025; GBA plus five new city corporations are in a \"Phased Implementation\" stage (2025–2026) — merging the corporations' databases, clearing a ₹437 Cr backlog of unpaid civic dues, and finalising the 2026 Master Plan; GBA elections are due by August 2026 (Supreme Court-directed), the first municipal poll in this area in 11 years.", "Verify with counsel that e-Khata records, property-tax PIDs and pending approval applications filed under the old BBMP regime carry over cleanly during the database-merger window — treat the pre-election period as a higher-risk window for record continuity, not a formality."],
    ...
    landAcquisition: [
      ...
      ["Bengaluru Business Corridor (ex-PRR)", "BDA has issued its first compensation awards, covering ~100 acres, breaking a years-long deadlock — officials say the pace of awards will accelerate from here. BDA needs ~2,560 acres in total (~₹20,511 Cr for land, ~₹26,786 Cr overall project cost); the Oct 2025 cabinet order already covers revised compensation for 948 acres (>50% of requirement); Package 1 (20 km, ₹3,348 Cr) tenders are at final-award stage; completion targeted around 2029.", "The award breakthrough should firm up the corridor-adjacent (North/East Bengaluru) price-appreciation thesis sooner than previously modelled — prioritise the NBR land-banking survey along the BBC alignment now, ahead of the accelerating award cycle."],
    ...
    recommendations: [
      { head: "Land Acquisition Strategy", color: NAVY, items: [
        "Time-critical: arrange EMD funding (₹4L/site) and finalise go/no-go on BDA Premium Sites e-Auction 2026 targets now — registration closes 27 Jul, live bidding runs to 31 Jul; the full window is barely a week away.",
        "Puravankara's new 6.4-acre Sarjapur JDA and Assetz's \"Melodies of Life\" pre-launch (Hosa Road/Sarjapur Road) both now sit inside or directly adjacent to NBR's own home corridor — treat this as an urgent signal to accelerate NBR's own pending Sarjapur-Mullur parcel negotiations, not defer them.",
        ...
        "Prioritise the Bengaluru Business Corridor land-banking survey now that BDA has begun issuing compensation awards (~100 acres) and signalled an accelerating pace — the price-appreciation thesis may firm up faster than previously modelled.",
      ]},
      { head: "Legal & Compliance", color: RED_RISK, items: [
        "Treat the GBA's pre-election, database-merger window (elections due by Aug 2026) as a higher-risk period for e-Khata/property-tax record continuity — confirm with counsel that any NBR parcel's records have migrated correctly rather than assuming automatic continuity.",
        ...
        "The Hosahalli-vs-Bidadi contrast (one quashed for fraud, one upheld for clean RFCTLARR process) is a clear instruction to legal: acquisitions and title chains stand or fall on documented statutory process — extend diligence on any NBR parcel with an older or cooperative-society acquisition history accordingly.",
      ]},
      { head: "Competitive Positioning", color: GREEN_POS, items: [
        "Puravankara developing inside Sarjapur itself (not just its periphery) is the most direct competitive overlap identified to date — commission an immediate pricing and positioning comparison against this specific JDA project.",
        "Brigade's dual-track model (own-account Whitefield-Hoskote acquisition plus a JV with Prestige elsewhere) and Prestige/Brigade's capital-light Old Madras Road lease both illustrate viable alliance structures NBR could adapt for parcels beyond its own balance-sheet capacity.",
        "Godrej Fund Management's purchase from Puravankara continues to point toward a maturing institutional-capital secondary market for land — keep evaluating fund-backed monetisation or JV capital partners as an option for NBR's own land bank.",
      ]},
    ],
  },
  ...
  layer2: {
    regional: [
      ...
      ["Andhra Pradesh / Amaravati", "The State Revenue Minister reaffirmed there will be no changes to the Amaravati capital region, following President Droupadi Murmu's April 2026 assent to the Andhra Pradesh Reorganisation (Amendment) Bill making Amaravati the sole permanent capital; land allotments to spiritual/religious organisations under the Amaravati Land Allotment Regulations, 2017 (\"social amenities\" clause) remain controversial, alongside the ongoing Phase II land-pooling (16,666.78 acres).", "The Minister's reassurance plus the confirmed permanent-capital status continue to de-risk the long-horizon Amaravati thesis modestly, but the allotment controversy remains a reminder that CRDA-pooled land can be redirected to non-commercial uses — a relevant factor if NBR ever engages with CRDA-administered land."],
