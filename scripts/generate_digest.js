...
const CONTENT = {
  ...
  editionNo: "Vol. I — Edition 041",

  execSummary: [
    { tag: "INFO", color: NAVY, text: "Background enrichment: Karnataka HC (dated April 2026, newly surfaced in this digest's research) ordered a CBI probe into a 2004 KIADB acquisition of 53+ acres in Hebbal/Hebbal Ammanikere, calling it a \"monumental fraud\" involving collusion with a non-existent firm (Lakeview Tourism Corporation) — the transfer was annulled and the firm fined ₹10 lakh. A further data point in the extensive pattern of judicial scrutiny of BDA/KIADB land dealings already tracked in this digest (NICE/BMICP, Hosahalli, D.B. Chandregowda, 2001/2004 BDA annulment)." },
