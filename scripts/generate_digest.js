...
const CONTENT = {
  ...
  layer1: {
    ...
    landAcquisition: [
      ...
      ["Dr K Shivaram Karanth Layout — Public Applications Open (Allotment Still Restrained)", "BDA began actual site allotment to ~3,200 land-giving farmers/landowners (~18,000 of 34,992 total sites) on 31 Aug 2026 at the ₹6,000/sq ft rate already on file. The same 31 Aug notification separately opened general-public applications for 2,815 further sites, with the online window running until 15 Oct 2026, 12 noon — following a Karnataka HC special-bench order (Justices M. Nagaprasanna and T. Venkatesh Naik) permitting BDA to accept applications while expressly clarifying that doing so does NOT amount to permission for actual allotment, which remains restrained pending further court orders.", "Two distinct tracks are now running in parallel: land-giver allotment already underway, and a separate 2,815-site general-public application window (deadline 15 Oct) whose actual allotment remains legally restrained. NBR should not assume the public-application phase converts into confirmed site supply on any fixed timeline — track the HC's further orders before treating these 2,815 sites as a firm future supply/comparable data point."],
