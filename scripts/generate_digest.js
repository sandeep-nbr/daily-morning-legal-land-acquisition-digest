...
const CONTENT = {
  ...
  editionNo: "Vol. I — Edition 059",

  execSummary: [
    { tag: "WATCH", color: AMBER_WATCH, text: "Two fresh Karnataka HC land-acquisition rulings point in opposite directions within days of each other: on 21 Sept the Court RESTORED a 2014-quashed DRDO acquisition at Benniganahalli for the Centre for Artificial Intelligence and Robotics (CAIR), holding national-security public purpose trumps personal rights; while on 29 Aug (newly captured on this tracker) the Court had QUASHED a 1,938-acre Karnataka Housing Board acquisition for Suryanagar Phase IV near Bannerghatta National Park, holding no public purpose can override elephant-corridor/eco-sensitive-zone conservation. Together these confirm Karnataka courts are deciding land-acquisition validity on purpose-specific merits (defence vs. environment vs. ordinary housing) rather than a uniform pro- or anti-acquisition tilt — directly relevant to how NBR should weigh acquisition risk on any parcel touching a defence, forest or eco-sensitive designation." },
    { tag: "INFO", color: NAVY, text: "Incremental movement on two already-tracked threads: Karanth Layout landowners have reportedly negotiated the BDA's proposed ₹54,000 administrative/development fee for a 30×40 site down toward ₹12,000 following discussions (exact formal confirmation still pending); and Kerala's CM has now constituted the promised \"Land Reforms 2.0\" expert committee (24 Sept, chaired by former Land Revenue Commissioner A.T. James) to review the Kerala Land Reforms Act, 1963 and related statutes. No update on the Siddhartha Vihar Trust BDA complaint, the Madras HC TNRERA ruling, the BBC (South)/Peripheral Ring Road-2 naming-ambiguity question, or HYDRAA beyond what is on file. No new Grade A/mid-tier Bengaluru land deal and no new NBR-specific news." },
  ],
...
["\"Bengaluru Business Corridor\" (South) / Peripheral Ring Road-2 — Final Notification", "The state issued a final land-acquisition notification (5 Sept 2026, per Vijay Karnataka) for 1,427.34 acres across 31 villages for a 52-km road connecting Mysuru Road to Hosur Road via Jigani, Bommasandra and Attibele — an 8-lane, 65m-wide carriageway within a 100m corridor. This is reported under the same \"Bengaluru Business Corridor\" name (and also as \"Peripheral Ring Road-2\") as the 74-km ex-PRR project already tracked in this digest (Tumakuru Road–Hosur Road, ~1,810 acres, ~948 acres notified 2008) — the routing described (a southern loop via Jigani/Bommasandra/Attibele) does not match the tracked project's alignment, suggesting these may be two distinct corridors sharing a name in press coverage, or inconsistent reporting of one project. Not yet resolved.", "Treat this as an open research item rather than settled fact — if it is genuinely a second, distinct southern corridor, it represents a fresh land-acquisition/compensation-opportunity zone (Jigani/Bommasandra/Attibele) outside NBR's core corridors that was not previously on this digest's radar; if it is the same tracked project under confused reporting, no new action is needed. Confirm with BDA/BBCL sources before treating either the acreage or routing as authoritative."],
    ...
    judicial: [
      ...
      ["Siddhartha Vihar Trust — BDA Civic-Amenity-Site Complaint Allowed to Proceed", "Karnataka HC (10 Sept 2026) set aside a trial-court order that had halted a private criminal complaint over a 2014 BDA civic-amenity-site allotment in Devarachikkanahalli, BTM Layout (to a trust on whose board members of Congress president Mallikarjun Kharge's family sit), on the ground that the complainant's accompanying affidavit had a curable verification defect. The Court directed the complainant be given an opportunity to cure the defect, after which the trial court is to consider the matter afresh under the statutory procedure for seeking investigation. This is a procedural ruling permitting the complaint to advance — the Court has not made any finding of fraud or wrongdoing.", "A further, lower-severity data point in the pattern of scrutiny on BDA's own land-allotment decisions (alongside Hebbal, D.B. Chandregowda and others already on file) — reported factually given its procedural (not substantive) posture; NBR should note the pattern without treating this specific matter as any kind of precedent yet, since no finding on the merits has been made."],
