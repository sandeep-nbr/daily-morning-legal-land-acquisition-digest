...
const CONTENT = {
  ...
  editionNo: "Vol. I — Edition 011",

  execSummary: [
    { tag: "HIGH", color: RED_RISK, text: "Karnataka HC stayed RERA applicability to BDA residential layouts where preliminary land acquisition notifications predate the 2016 RERA Act — interim relief was granted only until 6 July 2026, a date that has now passed without a confirmed follow-up order, leaving the actual current status unresolved." },
    { tag: "WATCH", color: AMBER_WATCH, text: "In a separate ruling, Karnataka HC held that RERA orders cannot be executed through civil courts — reinforcing that the recovery-certificate/revenue-recovery route (per the 8-week enforcement mandate flagged yesterday) is the correct enforcement channel, not a civil suit." },
    { tag: "WATCH", color: GREEN_POS, text: "BDA Commissioner Capt. Manivannan has appointed four dedicated Deputy Commissioners (Land Acquisition) to speed up negotiated Bengaluru Business Corridor settlements — Phase 1 (1,810 acres) is nearing completion and officials say the award pace is entering its most active phase since the project began." },
    { tag: "INFO", color: NAVY, text: "NBR Group itself is drawing positive trade-press coverage (Republic World) framing its \"rise into Bengaluru's Tier 1 developer league\" — useful external validation to be aware of alongside the competitive tracking in this digest." },
    { tag: "INFO", color: NAVY, text: "Sobha has confirmed it plans to maintain its ~₹1,150–1,160 Cr FY26 land-spend pace into FY27 as well — a signal of sustained (not one-off) acquisition intensity from this Grade A peer." },
  ],

  layer1: {
    regulatory: [
      ["K-RERA Registrations & Scope", "K-RERA has now registered 28,000+ projects and 35,000+ agents since inception; residential projects which applied for an Occupancy Certificate before 1 May 2017 remain exempt from mandatory RERA registration; N. Jayaram (retired 2004-batch IAS officer, former Secretary to CM Siddaramaiah) has been appointed a K-RERA Member for a 5-year term. Separately, Karnataka HC (Justice Suraj Govindaraj, 3 Jun 2026) stayed RERA applicability to BDA residential layouts where preliminary land acquisition notifications predate the 2016 RERA Act — interim relief ran only until 6 Jul 2026, a date now passed without a confirmed follow-up order.", "Confirm registration status (or exemption basis) for every NBR project before marketing. The pre-2016-notification exemption for BDA layouts is a DIFFERENT carve-out from the pre-2017-OC exemption already on file — if NBR has any project on land whose acquisition predates 2016, seek updated status on this stay before assuming continued exemption, since the interim order's expiry date has passed."],
      ["K-RERA Enforcement — Orders, Recovery, Routes & Limits", "Beyond the Adarsh Nivas (₹79.84 lakh) and Casagrand Garden City (₹52.74 lakh) orders, the ₹92 Cr/₹758 Cr recovery gap, and the 8-week recovery-certificate enforcement mandate already on file, Karnataka HC has separately ruled that K-RERA orders CANNOT be executed through civil courts — reinforcing that the revenue-recovery-certificate route is the only proper enforcement channel; the HC has also overturned a K-RERA order that applied a delay fee retroactively.", "The civil-court ruling closes off an alternative enforcement route homebuyers or K-RERA might otherwise try — confirms that any K-RERA order against NBR (or any peer) will be enforced only via the recovery-certificate/revenue-recovery mechanism, now itself subject to the 8-week mandate."],
    ...
    landAcquisition: [
      ["BDA Premium Sites e-Auction 2026", "13th BDA e-auction this year (175 sites, incl. high-demand plots in Arkavathi Layout, Anjanapura Township, Banashankari 6th Stage and Sir M. Visvesvaraya Layout); registration/interest closed 5 PM today, 27 Jul 2026; timed bidding now moves into rounds over 28–31 Jul 2026 (each round 11 AM to 5 PM the next day) on the Karnataka Public Procurement Portal, sold \"As Is Where Is\" under the BDA's 1984 Disposal Rules.", "The registration window has closed — any NBR site of interest not yet registered has missed this round; for sites NBR did register for, prepare bidding strategy now given the 10%-above-reserve and single-bidder-rejection rules already on file."],
      ["Bengaluru Business Corridor (ex-PRR)", "BDA Commissioner Capt. Manivannan has appointed four dedicated Deputy Commissioners (Land Acquisition) specifically to speed up processing of negotiated settlements; Phase 1 (1,810 acres) is nearing completion and officials describe the award pace as entering its most active phase since the project began — building on consent letters already arriving, published village-wise compensation (₹2.50–15.60 Cr/acre), the 40%-residential-plot offer, and the court-deposit-and-proceed construction plan (SNC as L1 bidder) already on file. The Section 27/Madavara legal challenges remain unresolved in parallel.", "The dedicated-DC appointment is a clear administrative signal the state wants Phase 1 wrapped up soon — NBR's BBC-alignment land-banking survey should treat near-term completion of Phase 1 land acquisition as increasingly likely, while the underlying legal challenge remains the key residual uncertainty to track."],
    ...
    judicial: [
      ...
      ["K-RERA Retroactive Delay-Fee Overturned", "Karnataka HC overturned a K-RERA order that had applied a possession-delay fee retroactively against a developer, finding the retroactive application impermissible.", "A developer-favourable precedent worth keeping on file — if K-RERA ever calculates a delay fee against an NBR project reaching back further than the relevant trigger date, this ruling supports challenging the retroactive portion of the calculation."],
    ],
    gradeA: [
    ...
    recommendations: [
      { head: "Land Acquisition Strategy", color: NAVY, items: [
        "BDA's dedicated four-DC team for BBC negotiated settlements signals near-term completion of Phase 1 land acquisition is a real possibility, not just an aspiration — revisit NBR's BBC-alignment land-banking survey timeline assumptions accordingly.",
        "Prestige's developer-funded private flyover (Bellandur–Kariyammana Agrahara) remains a live precedent for unlocking connectivity-constrained land via self-funded infrastructure — evaluate whether any NBR parcel with an access constraint could benefit from a similar BBMP/GBA-approved structure.",
      ...
      { head: "Legal & Compliance", color: RED_RISK, items: [
        "If any NBR project sits on land whose acquisition notification predates 2016, obtain updated status on the Karnataka HC's RERA-applicability stay for BDA layouts — its interim relief expired 6 Jul 2026 without a confirmed follow-up order, so the current exemption status needs active confirmation, not assumption.",
        "The civil-court-execution ruling confirms K-RERA orders can only be enforced via the revenue-recovery-certificate route (now subject to the 8-week mandate already on file) — useful clarity on the realistic enforcement pathway and timeline for any future adverse order.",
  ...
  layer2: {
    regional: [
      ...
      ["Telangana / Hyderabad", "Hyderabad residential registrations fell 14% YoY in January 2026 (transaction values down 16%), with industry stakeholders citing \"policy uncertainty, administrative decisions and global headwinds\" — market-level evidence behind the HYDRAA-driven uncertainty narrative, alongside the Telangana HC's direct call for the Chief Secretary to REPLACE HYDRAA Commissioner Ranganath (who cites ~₹1.5 lakh Cr in reclaimed public assets in his defence) and its ruling that GHMC cannot acquire private land without owner consent.", "The registration-decline data confirms the enforcement uncertainty is not just a legal abstraction — it appears to be dampening actual transaction activity; NBR should factor a measurable demand-side discount, not just a legal-risk premium, into any Hyderabad market entry analysis."],
    ...
    recommendations: [
      { head: "Regional Positioning", color: NAVY, items: [
        "Hyderabad's 14% YoY registration decline (Jan 2026) gives the HYDRAA enforcement-risk narrative measurable market backing — treat Hyderabad as a materially higher-friction, currently softening market versus Karnataka, not just a legally riskier one.",
