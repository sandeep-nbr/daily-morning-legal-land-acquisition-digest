...
const CONTENT = {
  ...
  editionNo: "Vol. I — Edition 046",

  execSummary: [
    { tag: "WATCH", color: AMBER_WATCH, text: "BDA has notified a change of land use (CLU) converting 17.49 acres in Sulikere (off Mysuru Road, western Bengaluru) — originally earmarked for a transport hub — to residential use, with 49 residential sites having reportedly already been formed on part of the land years ago without the mandatory state government approval. Deccan Herald frames this as raising serious questions of whether BDA itself flouted planning and approval processes on its own project." },
