...
const CONTENT = {
  ...
  editionNo: "Vol. I — Edition 030",

  execSummary: [
    { tag: "HIGH", color: RED_RISK, text: "Today is the final day of the B-Khata→A-Khata 2% conversion window (15 May – 23 Aug 2026) — from tomorrow the fee reverts to the standard 5% of guidance value. No extension has been announced; any NBR B-Khata conversion filing not submitted by end of today misses the reduced-rate window entirely." },
    { tag: "WATCH", color: AMBER_WATCH, text: "BDA has raised the price of sites in the 3,069-acre Dr K Shivaram Karanth Layout (North Bengaluru, ~34,000 sites planned) to ₹6,000/sq ft — a ~22% hike from the ₹4,900/sq ft rate fixed in late 2023, making a standard 30x40 site ~₹72 lakh. Allotment will proceed in two phases (first phase ~3,000 sites) due to ongoing legal proceedings." },
    { tag: "INFO", color: NAVY, text: "The 7 Aug K-REAT email-consent ruling already on file is confirmed as Sobha Ltd. v. Karnataka RERA (Appeal K-REAT 84/2025) — Sobha itself was the promoter that relied on authenticated email consent from allottees to implement project alterations, and the Tribunal upheld this as valid written consent under Section 14(2)(ii)." },
    { tag: "INFO", color: NAVY, text: "No public BDA response yet to the BBC Governor petition; otherwise a quiet run — no new NBR-specific news or fresh Grade A/mid-tier Bengaluru land deal since the last edition." },
  ],
  ...
  layer1: {
    regulatory: [
      ...
      ["B-Khata → A-Khata Window", "TODAY (23 Aug 2026) is the final day of the 2%-of-guidance-value conversion window (15 May – 23 Aug 2026), with no extension announced. From tomorrow (24 Aug) the fee reverts to the standard 5% of guidance value.", "Final-hours priority — any pending NBR B-Khata conversion filing must be submitted today to lock in the 2% rate; missing today's close means paying the full 5% rate (a multi-lakh cost difference on a typical site) with no confirmed date for a similar reduced-rate window to recur. Confirm with the legal team by end of day whether all eligible NBR filings were submitted in time."],
    ...
    recommendations: [
      ...
      { head: "Legal & Compliance", color: RED_RISK, items: [
        ...
        "Today (23 Aug) is the final day of the B-Khata→A-Khata 2%-conversion window, with only a fraction of the ~7 lakh eligible properties converted before close — confirm by end of day whether any pending NBR B-Khata filing was submitted in time; from tomorrow the fee reverts to the standard 5% of guidance value with no confirmed date for a similar reduced-rate window to recur.",
      ]},
