...
const CONTENT = {
  ...
  editionNo: "Vol. I — Edition 058",

  execSummary: [
    { tag: "WATCH", color: AMBER_WATCH, text: "Andhra Pradesh officials have now framed Amaravati's Phase II land-pooling ask more broadly at 40,000-45,000 acres (State Minister P. Narayana: ~10,000 acres for an airport/smart-industries/sports-city flagship cluster) — but farmers and activists have raised a notable new concern: Phase 1's pooled land (2014-19) has still not been fully developed or serviced, meaning the government has not fulfilled its commitments to the original contributors before seeking more land. Pedamaddur's own pooling has progressed to ~70.66-75%. A useful caution on AP's land-delivery execution track record, though still not a Karnataka/Bengaluru-relevant opportunity for NBR." },
    { tag: "INFO", color: NAVY, text: "Otherwise a quiet day: no update on the Karanth Layout objections window or public-application/allotment-restraint question, no update on the Siddhartha Vihar Trust BDA complaint or the Madras HC TNRERA title-jurisdiction ruling, no new Grade A/mid-tier Bengaluru land deal, no fresh Karnataka HC land ruling beyond what is already on file, no update on the flagged BBC (South)/Peripheral Ring Road-2 naming-ambiguity question, no public BDA response to the original BBC Governor petition, and no developments in HYDRAA or Kerala beyond what is already on file. No new NBR-specific news." },
  ],
