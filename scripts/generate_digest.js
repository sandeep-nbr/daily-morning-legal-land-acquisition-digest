...
const CONTENT = {
  ...
  editionNo: "Vol. I — Edition 045",

  execSummary: [
    { tag: "INFO", color: NAVY, text: "Background enrichment: Godrej Properties' 26-acre land purchase near Sarjapur Road, Bengaluru (~₹1,100 Cr revenue potential, announced Oct 2025) had not previously been captured in this tracker; it is now added to Godrej's profile as historical context, further reinforcing Sarjapur Road as one of Godrej's most active Bengaluru corridors alongside its more recent ~3.8-acre/30-acre-combined assembly already on file." },
