...
const CONTENT = {
  ...
  editionNo: "Vol. I — Edition 023",

  execSummary: [
    { tag: "WATCH", color: AMBER_WATCH, text: "Brigade Enterprises' board meets today to approve Q1 FY27 results (expected after market hours) — the final data point in this earnings season to confirm whether Prestige's pre-sales decline was an outlier against Godrej/Sobha/Puravankara's growth. Separately, Brigade is pursuing a ₹1,500 Cr NCD fundraise and seeking to raise its borrowing limit to ₹10,000 Cr." },
    { tag: "INFO", color: NAVY, text: "A new Karnataka HC ruling (Shailesh B. Charati v. Arya Gruha Pvt. Ltd., \"Arya Hamsa\" project) holds that flat owners cannot claim exclusive rights over common amenities where the registered sale deed permits residents of different project phases to share them — the Division Bench upheld the K-RERA/KREAT orders on appeal." },
    { tag: "INFO", color: NAVY, text: "Telangana HC has opened a SEPARATE suo motu contempt proceeding against HYDRAA Commissioner Ranganath — this time over demolitions at Malkajgiri's Vani Cooperative Housing Society despite a subsisting stay order — a second, distinct contempt thread beyond the 63-petition basis for his removal order already on file." },
    { tag: "INFO", color: NAVY, text: "Andhra Pradesh officially launches the 21.77 km Amaravati Seed Access Road (E3) today — a 3-phase BRTS/cycle-track/green-belt corridor and a concrete infrastructure milestone for the capital's build-out. No BDA response yet to the BBC Governor petition." },
  ],
  ...
  layer1: {
    ...
    landAcquisition: [
      ...
      ["Bengaluru Business Corridor (ex-PRR)", "The corridor's most direct legal challenge to date has now surfaced: the PRR Farmers and Site Owners Association has petitioned Governor Thaawar Chand Gehlot to scrap the project outright, arguing the original June 2007 acquisition notification lapsed under the old 1894 Land Acquisition Act for want of an award within 5 years — and separately noting BDA has not obtained a DPR, Social Impact Assessment, or NGT clearance, and is still using the 1894 Act rather than the 2013 LARR Act used by BMRCL/NHAI. Separately, 250+ farmers/landowners have filed a High Court petition specifically over the 3.8 km Madavara-intersection stretch. This layers onto the 65m/35m land-use revision, 2-month objection window and ~₹8,385/sq ft commercial-plot compensation rate already on file.", "The lapsed-notification argument is the SAME dormancy doctrine that has repeatedly succeeded for landowners in Karnataka HC rulings tracked in this digest (NICE/BMICP, Hosahalli, the 2001/2004 BDA annulment) — this is a materially stronger legal threat to the corridor's validity than the compensation disputes previously on file. Model a genuine scenario where courts could still quash all or part of the 2007 notification, not just a negotiated-compensation outcome; re-check any BBC-adjacent parcel for reliance on this notification's continued validity."],
    ...
    gradeA: [
      ...
      ["2", "Brigade Group", "Board meets today (13 Aug 2026) to approve Q1 FY27 results, alongside its 31st AGM and an investor call the following day — the final Grade A earnings data point this season, after Godrej (+22%), Sobha (+76%) and Puravankara (+28%) all grew while Prestige fell ~46%. Separately, Brigade is pursuing a ₹1,500 Cr NCD fundraise and seeking board approval to raise its overall borrowing limit to ₹10,000 Cr — alongside the Kanakapura Road parcel, Whitefield-Hoskote mixed-use development and Malur plotted development already on file.", "8+ deals / ~123 acres FY26; Whitefield-Hoskote ₹5,200 Cr GDV; Q1 FY27 results + ₹1,500 Cr NCD fundraise approval expected today", "Results were not yet public as of this morning's research — check tomorrow's edition for the actual Q1 FY27 print, which will settle whether this earnings season reflects broad Bengaluru strength (3 of 4 peers so far) or a more mixed picture. The ₹10,000 Cr borrowing-limit ask signals Brigade is positioning for continued aggressive expansion regardless of the quarter's result."],
    ...
    recommendations: [
      ...
      { head: "Legal & Compliance", color: RED_RISK, items: [
        ...
        "With the B-Khata→A-Khata 2%-conversion window now just under two weeks from closing (23 Aug), fast-track conversion filings for any NBR-held or under-acquisition B-Khata parcels — this should be treated as a near-term legal-team deadline, not a background item.",
      ]},
      { head: "Competitive Positioning", color: GREEN_POS, items: [
        "With 3 of 4 reporting Grade A peers now posting strong Q1 FY27 growth (Godrej +22%, Sobha +76%, Puravankara +28%) against only Prestige's ~46% decline, the balance of evidence now points to Prestige's result being company-specific/high-base-driven rather than a sector-wide slowdown — Brigade's 13 Aug results are the last confirming data point, but NBR's own planning should not assume broad Bengaluru demand weakness from this season.",
        "Sobha's shift to net cash positive (₹659 Cr) alongside 76%-YoY sales growth is the standout balance-sheet result this earnings season — a useful benchmark for pairing growth with financial discipline in NBR's own land-acquisition funding strategy.",
  ...
  layer2: {
    regional: [
      ...
      ["Telangana / Hyderabad", "The HYDRAA fight now runs on two separate contempt tracks: alongside the Telangana government's decision to formally appeal the commissioner-removal order (Article 311 grounds), the HC has opened a SEPARATE suo motu contempt proceeding (Justice N.V. Shravan Kumar) against Commissioner Ranganath specifically over demolitions at Malkajgiri's Vani Cooperative Housing Society carried out despite a subsisting status quo/stay order. This layers onto the contempt notices already issued to five senior IAS/IPS officers, the Sangareddy 861-acre reclamation, and the Section 22A land-freeze designations already on file.", "A second, independent contempt proceeding — on top of the appeal — shows the courts pursuing HYDRAA's compliance record on multiple fronts simultaneously, not just the single removal order; this makes a quick resolution even less likely. Continue treating Section 22A flag status as an independent Hyderabad diligence item regardless of how any of these proceedings resolve."],
      ["Andhra Pradesh / Amaravati", "Andhra Pradesh officially launches the 21.77 km Amaravati Seed Access Road (E3) today — a 3-phase corridor with BRTS, dedicated cycle tracks, sidewalks, green belts and utility infrastructure, linking key locations across the capital region. This is a concrete infrastructure delivery milestone alongside the August 2028 Phase 1 completion target, the ongoing Gram Sabhas (Tadikonda/Mothadaka farmers agreed in principle; Kantheru still deciding), and the 20,494-acre acquisition breakdown already on file.", "A completed connectivity corridor (rather than just a target date or a pooling announcement) is the first tangible built-infrastructure evidence that Amaravati's capital build-out is actually progressing on the ground — worth noting as a positive signal if AP market entry is ever revisited, though land-pooling consent remains the more immediate watch item."],
    ...
    recommendations: [
      { head: "Regional Positioning", color: NAVY, items: [
        "Telangana's decision to formally appeal the HC's HYDRAA-commissioner removal order (on Article 311 separation-of-powers grounds) signals this dispute will run for months — do not assume any near-term change in HYDRAA's enforcement posture or leadership either way; Section 22A land-freeze designations remain a distinct, separate Hyderabad diligence risk to check on any parcel regardless of the appeal's outcome.",
