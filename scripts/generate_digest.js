...
const CONTENT = {
  ...
  editionNo: "Vol. I — Edition 010",

  execSummary: [
    { tag: "HIGH", color: GREEN_POS, text: "Karnataka HC (27 Apr 2026 ruling, resurfacing now) ordered that K-RERA recovery certificates must be enforced by designated authorities within 8 weeks of issue — a direct judicial fix aimed at the very recovery gap flagged in this digest (only ₹92 Cr of ₹758 Cr owed had been collected)." },
    { tag: "WATCH", color: AMBER_WATCH, text: "In a separate ruling, Karnataka HC overturned a K-RERA retroactive delay-fee order — a developer-favourable precedent limiting how far back K-RERA can apply delay penalties." },
    { tag: "WATCH", color: GREEN_POS, text: "BBC compensation negotiations show real progress: consent letters have begun arriving from landowners, with village-wise compensation (₹2.50–15.60 Cr/acre) now published, and BDA has extended a 40%-residential-plot offer to farmers amid the acquisition disputes." },
    { tag: "WATCH", color: RED_RISK, text: "Hyderabad residential registrations fell 14% YoY in January 2026 (transaction values down 16%), with industry stakeholders citing \"policy uncertainty [and] administrative decisions\" — a market-level data point that gives the HYDRAA enforcement-risk narrative real teeth beyond individual disputes." },
    { tag: "INFO", color: NAVY, text: "No new NBR-specific news, Grade A/mid-tier land deals, or guidance-value gazette notification since yesterday; the BDA e-auction bidding rounds conclude today (31 Jul) and the B-Khata window remains open through 23 Aug." },
  ],
  ...
  layer1: {
    regulatory: [
      ...
      ["K-RERA Enforcement — Orders, Recovery & Limits", "Beyond the Adarsh Nivas (₹79.84 lakh) and Casagrand Garden City (₹52.74 lakh) orders and the ₹92 Cr/₹758 Cr recovery gap already on file, Karnataka HC (Rajesh Rao C.V. v. State of Karnataka, 27 Apr 2026) has ordered that K-RERA recovery certificates must be enforced by designated authorities within 8 weeks of issue — directly targeting the collection shortfall; separately, the HC has also overturned a K-RERA order that applied a delay fee retroactively, limiting how far back such penalties can reach.", "The 8-week enforcement mandate should meaningfully close the recovery gap going forward — treat any future adverse K-RERA order against NBR as more likely to be actually collected than historical data alone suggested; conversely, the retroactive-fee ruling is a useful defence precedent if NBR ever contests a delay-fee calculation reaching back further than reasonable."],
    ...
    landAcquisition: [
      ...
      ["Bengaluru Business Corridor (ex-PRR)", "Compensation negotiations are showing real momentum: consent letters have begun arriving from landowners, village-wise compensation figures (₹2.50–15.60 Cr/acre, reflecting the five-option formula the Cabinet cleared) are now published on BDA's website, and BDA has extended a 40%-of-relinquished-land residential-plot offer to farmers amid the ongoing disputes. This runs alongside the court-deposit-and-proceed construction plan (SNC as L1 bidder, 79% land acquired on the first stretch) and the still-unresolved Section 27/Madavara legal challenges already on file.", "Consent letters actually arriving is the clearest sign yet that the compensation framework — however legally contested — is gaining practical traction with landowners; NBR's BBC-alignment land-banking survey should treat negotiated settlement as an increasingly realistic base case, while still tracking the parallel legal case as a residual risk."],
    ...
    recommendations: [
      { head: "Land Acquisition Strategy", color: NAVY, items: [
        "BBC consent letters starting to arrive, alongside published village-wise compensation figures, mean negotiated settlement is becoming a realistic base case for corridor-adjacent land — revisit NBR's BBC-alignment land-banking survey assumptions accordingly, while still keeping the unresolved Section 27/Madavara legal risk on the watch list.",
      ...
      { head: "Legal & Compliance", color: RED_RISK, items: [
        "The new 8-week K-RERA recovery-certificate enforcement mandate should be factored into NBR's own RERA compliance risk model — an adverse order is now more likely to be actually collected against than the historical ~12% recovery rate would suggest.",
        "Keep the K-RERA retroactive delay-fee ruling on file as a ready defence precedent, should K-RERA ever calculate a delay penalty against an NBR project reaching back further than a reasonable trigger date.",
