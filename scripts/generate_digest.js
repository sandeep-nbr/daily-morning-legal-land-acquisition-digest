...
const CONTENT = {
  ...
  editionNo: "Vol. I — Edition 035",

  execSummary: [
    { tag: "WATCH", color: AMBER_WATCH, text: "BDA begins actual site allotment in the Dr K Shivaram Karanth Layout TODAY (31 Aug) — the long-delayed North Bengaluru layout's first concrete distribution step, with ~18,000 of the 34,992 planned sites reserved for ~3,200 land-giving farmers/landowners first; public applications are expected to follow, subject to Chief Minister approval. Confirms the ₹6,000/sq ft pricing (~₹72 lakh for a standard 30x40 site) already on file is now operative, not just proposed." },
    { tag: "INFO", color: NAVY, text: "Andhra Pradesh has ordered a fresh 20,494-acre second-phase land-pooling round for Amaravati (16,562.56 acres patta land, 104.01 acres assigned land, 3,828.30 acres government land across 7 villages) for an expanded International Sports City (now 2,500 acres, up from 70), a greenfield international airport, a new railway station and the Inner Ring Road — a substantial escalation beyond the 2,344-acre round already on file." },
    { tag: "INFO", color: NAVY, text: "Otherwise a quiet stretch: no new Grade A/mid-tier Bengaluru land deal, no fresh Karnataka HC land ruling since the Lalitha S. GST-compensation decision, no public BDA response to the BBC Governor petition, and no new NBR-specific news since the last edition." },
  ],
  ...
  layer1: {
    ...
    recommendations: [
      { head: "Land Acquisition Strategy", color: NAVY, items: [
        "Karanth Layout's shift from priced-but-unallotted to actual site distribution today makes ₹6,000/sq ft a live North Bengaluru comparable rather than a proposed rate — use it as a current benchmark for any nearby NBR parcel evaluation, and watch for the public-application phase (pending CM approval) as the next site-supply signal.",
