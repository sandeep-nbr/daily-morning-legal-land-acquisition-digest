...
const CONTENT = {
  ...
  layer1: {
    ...
    landAcquisition: [
      ...
      ["Dr K Shivaram Karanth Layout — Site Allotment Begins", "BDA has begun actual site allotment in the 3,069-acre Dr K Shivaram Karanth Layout (North Bengaluru) TODAY (31 Aug 2026) at the ₹6,000/sq ft rate already on file (~₹72 lakh for a standard 30x40 site) — ~18,000 of the 34,992 total planned sites are reserved for ~3,200 land-giving farmers/landowners in this first tranche, with public applications expected to follow subject to Chief Minister approval.", "The shift from a priced-but-unallotted layout to actual site distribution is a material milestone — the ₹6,000/sq ft benchmark for North Bengaluru land cost is now a live, operative transaction price rather than a proposed one; NBR should treat it as a current comparable for any nearby parcel evaluation, and watch for the public-application phase as a further site-supply signal once CM approval comes through."],
