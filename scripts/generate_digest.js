...
const CONTENT = {
  ...
  editionNo: "Vol. I — Edition 015",

  execSummary: [
    { tag: "HIGH", color: RED_RISK, text: "Yesterday's BDA favouritism finding is now identified: Karnataka HC nullified a 2010 BDA site allotment to the daughter of former MP D.B. Chandregowda, ruling it illegal and a product of political favouritism that violated mandatory eligibility rules — concrete detail behind what was a general finding in the last edition." },
    { tag: "WATCH", color: RED_RISK, text: "In a separate, unrelated case, Karnataka HC annulled a 2001/2004 BDA land acquisition in North Bengaluru as \"bad in law,\" finding BDA had abandoned the scheme and failed to complete it within the mandated timeframe — yet another entry in the pattern of dormant/abandoned BDA acquisitions being struck down." },
    { tag: "WATCH", color: AMBER_WATCH, text: "Casagrand is launching a new luxury residential project directly on Sarjapur Road — the latest peer (after Puravankara, Godrej, Adarsh, Assetz) to enter NBR's core home corridor in the roughly two weeks this digest has been tracking it." },
    { tag: "WATCH", color: GREEN_POS, text: "Salarpuria Sattva has launched a 50-acre, 2,500-unit housing township in North Bengaluru targeting ₹8,600 Cr revenue, and Sumadhura Infracon has announced a ~₹5,000 Cr (₹50 billion) three-year investment plan — both signal a step-change in scale from names this digest has tracked mostly on smaller individual launches." },
    { tag: "INFO", color: NAVY, text: "Karnataka HC separately dismissed a challenge to a decades-old BDA acquisition filed 53 years after the fact — a useful counter-example showing extreme delay can defeat a PETITIONER's case just as it can defeat the acquiring authority's, depending on the facts." },
  ],
  ...
  layer1: {
    ...
    landAcquisition: [
      ...
      ["Bengaluru Business Corridor (ex-PRR)", "Commercial-plot compensation has now been set at ~₹8,385/sq ft, adding precision to the ₹2.50–15.60 Cr/acre residential compensation range already on file. This sits alongside the contested picture already on file: real administrative momentum (8-committee/18-location consultation structure, the new Addl. Chief Secretary-chaired deadlock committee) against continued farmer resistance to negotiated settlement. Package 1 (19.80 km, ₹3,348 Cr) drew bids from Shankara Narayana Constructions (\"SNC\") and Vishwa Samudra Engineering.", "The precise commercial-plot rate (~₹8,385/sq ft) gives NBR a concrete benchmark for valuing any TDR/commercial-plot compensation option along the corridor — factor it into land-banking survey economics alongside the residential range already on file."],
    ...
    midTier: [
      ...
      ["9", "Sumadhura Group", "Group entity Sumadhura Infracon has announced a ~₹5,000 Cr (₹50 billion) investment plan over the next three years — a step-change beyond the ₹250 Cr twin-tower project, 40-acre pipeline (~₹6,000 Cr potential), Sumadhura Aikya (Soukya Road) and Panathur plotted foray already on file.", "~₹5,000 Cr 3-year investment plan (Sumadhura Infracon); Residential, plotted, multi-city (Bengaluru + Hyderabad)"],
    ...
    recommendations: [
      { head: "Land Acquisition Strategy", color: NAVY, items: [
        "Casagrand's new Sarjapur Road luxury launch is the fourth-plus Grade A/mid-tier entrant this digest has flagged inside NBR's home corridor in two weeks (after Puravankara, Godrej, Adarsh, Assetz) — this pace of entry should now factor into near-term pricing and launch-timing decisions on any NBR Sarjapur project, not just be logged as a watch item.",
        "Model BBC Phase 1 completion on TWO scenarios, not one — an optimistic near-term-completion case and a pessimistic continued-standoff case — rather than treating recent momentum signals as a settled trajectory.",
      ...
      { head: "Legal & Compliance", color: RED_RISK, items: [
        "The D.B. Chandregowda allotment-cancellation detail confirms BDA favouritism findings can reach back over a decade (2010 allotment cancelled in 2026) — independently verify the beneficiary-eligibility basis, not just the bid/allotment paperwork, on any BDA-sourced site NBR evaluates.",
        "The new 2001/2004 BDA acquisition annulment adds to a now well-documented pattern (NICE/BMICP, Hosahalli) of Karnataka courts striking down dormant/abandoned acquisitions — but the 53-years-later dismissal is a reminder the pattern isn't unconditional: outcomes turn on WHO caused the delay and why, not delay alone.",
      ...
      { head: "Competitive Positioning", color: GREEN_POS, items: [
        "Sattva's 50-acre/₹8,600 Cr township and Sumadhura Infracon's ~₹5,000 Cr 3-year investment plan both mark a step-change from smaller individual launches previously tracked — reassess whether NBR's Grade A/mid-tier competitive tiering still reflects these two peers' actual scale.",
        "Brigade's spread across South (Kanakapura Road), East (Whitefield-Hoskote) and outer (Malur) Bengaluru shows a broader simultaneous multi-corridor push than most peers — track where this pattern points next, since it suggests Brigade is not committed to any single micro-market the way NBR is to Sarjapur.",
