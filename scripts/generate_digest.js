...
const CONTENT = {
  ...
  editionNo: "Vol. I — Edition 006",

  execSummary: [
    { tag: "HIGH", color: RED_RISK, text: "Farmers' 1,000+ objections to the Bengaluru Business Corridor now rest on three grounds, not one: the scheme has legally lapsed (Section 27 BDA Act), the wrong acquisition law is being applied (1894 Land Acquisition Act instead of RFCTLARR 2013), and the state's own \"five-option\" compensation package is itself unlawful/discriminatory — and PRR landowners have warned HUDCO to halt funding until these issues are settled." },
    { tag: "HIGH", color: AMBER_WATCH, text: "BDA's Premium Sites e-Auction 2026 registration window has now closed (5 PM today) — 175 sites move into timed bidding rounds from 28-31 Jul; any NBR site of interest not yet registered has missed this round." },
    { tag: "WATCH", color: GREEN_POS, text: "Adarsh Developers has launched Adarsh Tropica Phase II directly on Sarjapur Road, alongside Adarsh Rosewood in Bellandur — placing another tracked mid-tier peer's active pipeline directly inside NBR's own core operating corridor." },
    { tag: "WATCH", color: AMBER_WATCH, text: "Puravankara's Bengaluru developable land bank now stands at 25.61 million sq ft, and its Embassy Eden construction contract is confirmed to run through subsidiary Starworth Infrastructure & Construction Ltd (SICL) — reinforcing Puravankara as the single most acquisitive Grade A peer tracked in this digest." },
    { tag: "INFO", color: NAVY, text: "Brigade Group's first plotted development in East Bengaluru — a 20+ acre project in Malur — is a reminder that Grade A players are also entering the plotted-development segment NBR itself competes in, not just high-rise apartments." },
  ],
  ...
  layer1: {
    ...
    landAcquisition: [
      ...
      ["Bengaluru Business Corridor (ex-PRR)", "Farmers' 1,000+ objections now rest on three distinct legal grounds: (1) the scheme has \"lapsed legally\" under Section 27 of the BDA Act, 1976 since no awards issued within the mandated 5-year period; (2) BDA is applying the wrong acquisition law (the colonial-era Land Acquisition Act, 1894) instead of the RFCTLARR Act, 2013; and (3) the state's own \"five-option\" compensation package is itself unlawful and discriminatory. Separately, PRR landowners have publicly warned HUDCO to halt further funding of the project until these legal issues are resolved, and are seeking a Karnataka HC hearing date on the objections. BDA needs ~2,560 acres in total; completion targeted around 2029.", "This is now a multi-front legal challenge (validity + applicable law + compensation-package legality), not just a compensation-amount dispute, and a funding-pressure campaign aimed at HUDCO adds a second track of risk — NBR's BBC-alignment land-banking survey should treat this as a genuinely open legal question, not a near-resolved formality."],
    ...
    gradeA: [
      ...
      ["2", "Brigade Group", "Its first plotted development in East Bengaluru — a 20+ acre project in Malur — sits alongside the 20.19-acre Whitefield-Hoskote parcel (₹588.33 Cr, via Ananthay Properties), the Prestige JV on Old Madras Road, and the Gunjur JDA (39-acre township, ₹7,200 Cr GDV) already on file.", "8+ deals / ~121 acres FY26 (incl. Malur plotted project and Whitefield-Hoskote parcel)", "Brigade entering plotted development (Malur) alongside its apartment/commercial pipeline puts it in more direct segment overlap with NBR's own plotted-development activity, not just high-rise apartments."],
      ...
      ["4", "Puravankara Limited", "Its Bengaluru developable land bank now stands at 25.61 million sq ft; the Embassy Eden civil/structural works contract (₹133.34 Cr LOI) is confirmed to run through wholly-owned subsidiary Starworth Infrastructure & Construction Ltd (SICL), on top of the KVN Property Holdings JV (24.59 acres, KIADB Hardware Park) and 6.4-acre Sarjapur JDA already on file. Godrej Fund Management separately bought a Bengaluru parcel from Puravankara.", "25.61 msf Bengaluru land bank; ~120 acres across 6 recent deals, ~₹13,300 Cr combined GDV", "Puravankara remains the single most acquisitive Grade A peer tracked in this digest — its scale (25.61 msf) plus JV-heavy growth model (KVN, Embassy/SICL) is now the clearest single benchmark for NBR's own land-bank pacing discussion."],
    ...
    recommendations: [
      { head: "Land Acquisition Strategy", color: NAVY, items: [
        "For any BDA e-auction site NBR did register for, finalise bidding strategy now (10%-above-reserve threshold, single-bidder rejection rule) ahead of the 28-31 Jul bidding rounds; for sites not registered, treat this round as closed and watch for the next e-auction cycle.",
        "The Bengaluru Business Corridor dispute is now a three-ground legal challenge (validity, applicable law, compensation-package legality) plus a HUDCO funding-pressure campaign — NBR's BBC-alignment land-banking survey should model a realistic chance of material delay or restructuring, not treat the current compensation framework as settled.",
        "Adarsh Developers' new Sarjapur Road launch (Tropica Phase II) is a direct signal that competitive intensity in NBR's home corridor keeps rising from multiple tiers (Grade A and mid-tier alike) — revisit pricing and absorption assumptions for any NBR project in the immediate Sarjapur Road vicinity.",
      ...
      { head: "Legal & Compliance", color: RED_RISK, items: [
        "Track the BBC's Section 27 lapse argument and the HUDCO funding-pressure campaign together as a single evolving legal/financing risk — a lapse finding or a HUDCO funding pause would each independently affect corridor-adjacent land economics on different timelines.",
      ...
      { head: "Competitive Positioning", color: GREEN_POS, items: [
        "Puravankara's 25.61 msf Bengaluru land bank and JV-heavy growth model (KVN, Embassy/SICL) remain the clearest single Grade A benchmark for NBR's own land-bank pacing — commission a focused competitive-response review specifically on this peer.",
        "Brigade's move into plotted development (Malur) is a reminder that Grade A players are now entering NBR's own plotted-development segment, not just competing in high-rise apartments — reassess NBR's plotted-development competitive set to include Grade A entrants.",
