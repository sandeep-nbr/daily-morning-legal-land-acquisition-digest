...
const CONTENT = {
  ...
  editionNo: "Vol. I — Edition 012",

  execSummary: [
    { tag: "HIGH", color: GREEN_POS, text: "The Telangana HC has now gone from asking the Chief Secretary to consider replacing HYDRAA Commissioner Ranganath to directly ORDERING his removal (1 Aug 2026) over repeat contemptuous violations of court orders — the clearest resolution yet of the escalating judicial-versus-HYDRAA saga tracked in this digest all week." },
    { tag: "WATCH", color: AMBER_WATCH, text: "BBC landowner consultations are now structured through 8 committees led by land acquisition officers across 18 locations — a more granular operational picture than the \"four Deputy Commissioners\" reported yesterday, suggesting a larger-than-expected administrative push to close out Phase 1." },
    { tag: "WATCH", color: RED_RISK, text: "Deccan Herald reports the BDA's rapid e-auction pace (a third bulk-land auction in quick succession, following a record ₹2,097 Cr first round) is now \"raising policy concerns\" — a critical framing worth weighing alongside the purely opportunistic read on BDA site availability this digest has carried." },
    { tag: "INFO", color: NAVY, text: "The Karnataka RERA Appellate Tribunal (KREAT, Mar 2026) separately classified BDA itself as a \"promoter\" under RERA and ordered it to register the Nadaprabhu Kempegowda Layout project — the ruling BDA is challenging via the pre-2016-acquisition stay flagged yesterday. The two rulings pull in opposite directions and the net position remains unsettled." },
    { tag: "INFO", color: NAVY, text: "No new NBR-specific news, fresh Grade A/mid-tier land deals, or guidance-value gazette notification since yesterday." },
  ],
  ...
  layer1: {
    ...
    landAcquisition: [
      ...
      ["Bengaluru Business Corridor (ex-PRR)", "Landowner consultations are now running through 8 committees led by land acquisition officers across 18 locations — a larger operational structure than the \"four Deputy Commissioners\" reported yesterday, reinforcing that Phase 1 (1,810 acres) closeout is a major administrative push, not a token gesture. This builds on consent letters already arriving, published village-wise compensation (₹2.50–15.60 Cr/acre), the 40%-residential-plot offer, and the court-deposit-and-proceed construction plan (SNC as L1 bidder) already on file. The Section 27/Madavara legal challenges remain unresolved in parallel.", "The 8-committee/18-location structure confirms the state is treating Phase 1 closeout as a priority operational campaign — NBR's BBC-alignment land-banking survey should treat near-term completion of Phase 1 land acquisition as increasingly likely, while the underlying legal challenge remains the key residual uncertainty to track."],
    ...
    recommendations: [
      { head: "Land Acquisition Strategy", color: NAVY, items: [
        "The 8-committee/18-location BBC consultation structure signals near-term completion of Phase 1 land acquisition is a real possibility, not just an aspiration — revisit NBR's BBC-alignment land-banking survey timeline assumptions accordingly.",
