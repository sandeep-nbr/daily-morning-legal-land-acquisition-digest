...
const CONTENT = {
  ...
  editionNo: "Vol. I — Edition 057",

  execSummary: [
    { tag: "INFO", color: NAVY, text: "Puravankara has entered Delhi-NCR for the first time — a 13.44-acre land parcel in Greater Noida (₹340 Cr, via subsidiary Prudential Housing and Infrastructure Development Ltd), with 4.57 msf saleable potential and ~₹5,200 Cr GDV, positioned near the Yamuna Expressway and the upcoming Noida International Airport (Jewar). This is Puravankara's largest FY27 land transaction and marks a strategic geographic diversification beyond South/West India — its FY27 business development across Delhi-NCR, Mumbai and Bengaluru now totals ~10.74 msf / ~₹14,100 Cr GDV." },
    { tag: "INFO", color: NAVY, text: "Otherwise a quiet day: no update on the Karanth Layout objections window or public-application/allotment-restraint question, no update on the Siddhartha Vihar Trust BDA complaint or the Madras HC TNRERA title-jurisdiction ruling, no fresh Karnataka HC land ruling beyond what is already on file, no update on the flagged BBC (South)/Peripheral Ring Road-2 naming-ambiguity question, no public BDA response to the original BBC Governor petition, and no developments in HYDRAA, Amaravati or Kerala beyond what is already on file. No new NBR-specific news." },
  ],
...
["\"Bengaluru Business Corridor\" (South) / Peripheral Ring Road-2 — Final Notification", "The state issued a final land-acquisition notification (5 Sept 2026, per Vijay Karnataka) for 1,427.34 acres across 31 villages for a 52-km road connecting Mysuru Road to Hosur Road via Jigani, Bommasandra and Attibele — an 8-lane, 65m-wide carriageway within a 100m corridor. This is reported under the same \"Bengaluru Business Corridor\" name (and also as \"Peripheral Ring Road-2\") as the 74-km ex-PRR project already tracked in this digest (Tumakuru Road–Hosur Road, ~1,810 acres, ~948 acres notified 2008) — the routing described (a southern loop via Jigani/Bommasandra/Attibele) does not match the tracked project's alignment, suggesting these may be two distinct corridors sharing a name in press coverage, or inconsistent reporting of one project. Not yet resolved.", "Treat this as an open research item rather than settled fact — if it is genuinely a second, distinct southern corridor, it represents a fresh land-acquisition/compensation-opportunity zone (Jigani/Bommasandra/Attibele) outside NBR's core corridors that was not previously on this digest's radar; if it is the same tracked project under confused reporting, no new action is needed. Confirm with BDA/BBCL sources before treating either the acreage or routing as authoritative."],
  ...
  layer2: {
    regional: [
      ...
      ["Andhra Pradesh / Amaravati", "Andhra Pradesh has ordered a substantial fresh second-phase land-pooling round for Amaravati — 20,494 acres (16,562.56 acres patta land, 104.01 acres assigned land, 3,828.30 acres government land) across 7 villages (Vaikuntapuram, Pedamadduru, Endrai, Karlapudi, Vaddamanu, Harischandrapuram, Pedaparimi) — for an expanded International Sports City (now 2,500 acres, up from an initial 70), a greenfield international airport, a new railway station and the Inner Ring Road. This is a much larger escalation than the 2,344.12-acre Inner Ring Road/Erraballen-Namburu round already on file, and adds to the Supreme Court's 14 Aug decision declining to interfere with the quashing of the criminal case against CM Naidu, the SIPB's ₹2,08,406 Cr investment approval and the Seed Access Road launch already on file.", "A 20,494-acre second-phase order is Amaravati's largest single land-pooling move flagged in this digest to date — confirms the capital build-out is scaling up materially, not just proceeding incrementally. Still not an actionable NBR opportunity given no Karnataka/Bengaluru nexus, but the growing scale (approaching the ~34,000 acres pooled in the original 2014-19 phase) is a stronger signal of AP's execution capacity if a South India footprint beyond Karnataka is ever revisited."],
