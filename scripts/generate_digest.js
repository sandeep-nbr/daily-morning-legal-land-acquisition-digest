...
// ---------------------------------------------------------------------------
const CONTENT = {
  dateLabel: "Tuesday, 4 August 2026",
  editionNo: "Vol. I — Edition 014",

  execSummary: [
    { tag: "WATCH", color: RED_RISK, text: "Karnataka HC has cancelled a BDA site allotment over favouritism — a corruption-adjacent finding worth tracking alongside the digest's running theme of courts scrutinising BDA's land dealings (NICE/BMICP quashings, RERA-promoter dispute)." },
    { tag: "WATCH", color: GREEN_POS, text: "Karnataka HC separately dismissed a PIL challenging transfer of 7 acres of KVAFSU (veterinary university) land for High Court judges' quarters and a new super-specialty hospital — a public-purpose land allocation upheld, reinforcing the pattern that clean-process acquisitions survive judicial review even amid the BDA favouritism finding above." },
    { tag: "WATCH", color: AMBER_WATCH, text: "Brigade Group has made a further outright purchase — a 2-acre Kanakapura Road parcel (South Bengaluru, ~₹400 Cr GDV) — its third distinct Bengaluru land move on file, alongside Whitefield-Hoskote and Malur." },
    { tag: "INFO", color: NAVY, text: "BBC commercial-plot compensation has been set at ~₹8,385/sq ft, adding precision to the ₹2.50–15.60 Cr/acre residential range already on file." },
    { tag: "INFO", color: NAVY, text: "No new NBR-specific news, K-RERA enforcement orders, or guidance-value gazette notification since yesterday." },
  ],
  ...
  layer1: {
    ...
    judicial: [
      ...
      ["BDA Site Allotment Cancelled Over Favouritism", "Karnataka HC cancelled a BDA site allotment after finding it was made on grounds of favouritism.", "Adds to a pattern of judicial scrutiny of BDA's land dealings (alongside the NICE/BMICP quashings and the contested RERA-promoter status) — reinforces that NBR should independently verify the allotment process behind any BDA-sourced site it evaluates, not just its paperwork."],
    ...
    recommendations: [
      ...
      { head: "Legal & Compliance", color: RED_RISK, items: [
        "The BDA favouritism-based allotment cancellation is a reminder to independently verify the fairness/process of any BDA site allotment NBR evaluates (e.g., via e-auction) — a clean bid process is now demonstrably necessary, not just sufficient, to survive challenge.",
        "The KVAFSU ruling reinforces that documented public purpose protects a land transfer from being unwound, even where a losing party has plausible institutional-harm arguments — useful precedent framing for any NBR land matter involving public-purpose justification.",
