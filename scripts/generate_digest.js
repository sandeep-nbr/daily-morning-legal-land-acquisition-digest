...
const CONTENT = {
  ...
  editionNo: "Vol. I — Edition 007",

  execSummary: [
    { tag: "HIGH", color: RED_RISK, text: "Over 250 farmers/landowners have filed a specific new HC petition against acquisition of a 3.8 km segment at the Madavara intersection of the Bengaluru Business Corridor — a targeted legal challenge on top of the broader 1,000+-objection, three-ground case already underway." },
    { tag: "WATCH", color: GREEN_POS, text: "Telangana HC has ruled that GHMC cannot acquire private land without owner consent, reinforcing that acquisition must be voluntary and duly compensated — a further judicial check on state agencies following last week's Army deployment against HYDRAA." },
    { tag: "WATCH", color: GREEN_POS, text: "GBA's revised draft voter list is out — 88.92 lakh voters across 369 wards and 8,024 planned polling stations — with the state government dismissing \"baseless\" claims that a proposed 650+-member nomination process would delay elections. Concrete progress on a previously ambiguous timeline." },
    { tag: "WATCH", color: AMBER_WATCH, text: "Puravankara's construction arm (Starworth/SICL) has now secured a second major contract — ₹311.18 Cr for the Sattva AANGANE project (3.04 msf, 37-month timeline) — on top of the Embassy Eden LOI, underscoring how deeply Puravankara's construction business is embedded across other Grade A developers' projects." },
    { tag: "INFO", color: NAVY, text: "Shriram Properties has signed a ₹600 Cr JDA for a 7-acre premium row-housing project in Yelahanka, North Bengaluru — its first fresh land move flagged in this digest, after several weeks with no new news." },
  ],
  ...
  layer1: {
    ...
    landAcquisition: [
      ...
      ["Bengaluru Business Corridor (ex-PRR)", "Beyond the broad 1,000+-objection, three-ground challenge (scheme lapse under Section 27 BDA Act; wrong acquisition law applied; unlawful compensation package) and the HUDCO funding-pressure campaign already on file, over 250 farmers/landowners have now filed a specific fresh HC petition against acquisition of a 3.8 km segment at the Madavara intersection. BDA needs ~2,560 acres in total; completion targeted around 2029.", "The Madavara petition shows the legal challenge is fragmenting into segment-specific fights as well as the broad scheme-wide one — NBR's BBC-alignment land-banking survey should track both the overall case and any segment-level petitions that touch its specific areas of interest."],
    ...
    gradeA: [
      ...
      ["8", "Shriram Properties", "Signed a ₹600 Cr JDA for a 7-acre premium row-housing project in Yelahanka, North Bengaluru — its first fresh land move on file after several quiet weeks.", "₹600 Cr JDA, 7 acres (Yelahanka)", "A premium row-housing format (vs. Shriram's usual plotted/apartment mix) in North Bengaluru — worth watching as a possible template if NBR considers a similar low-rise premium format."],
    ],
    midTier: [
      ...
      ["4", "Adarsh Developers", "New launches directly on NBR's home turf: Adarsh Tropica Phase II (off Sarjapur Road, 2.5/3 BHK) and Adarsh Rosewood (Bellandur, 2/3 BHK), alongside the CDP Road/Varthur project (12 acres, 1,248 units) already on file — even as K-RERA's ₹79.84 lakh delay-interest order and 60-day completion deadline on Adarsh Palm Acres Phase-2B remains a live enforcement action.", "Apartments, villas, plotted development — now with an active Sarjapur Road launch directly inside NBR's core corridor, while under active K-RERA enforcement"],
      ...
      ["9", "Sumadhura Group", "Acquired 40 acres (up to ₹6,000 Cr revenue-potential pipeline); Sumadhura Aikya launched on Soukya Road, East Bengaluru — 5 acres, 343 units (2/2.5/3 BHK) from ₹1.2 Cr, Whitefield-adjacent, K-RERA registration under process — alongside the earlier 3-tower/523-unit Soukya Road launch and Panathur plotted foray already on file.", "Residential, plotted, multi-city (Bengaluru + Hyderabad) — two separate Soukya Road launches now active"],
    ...
    recommendations: [
      { head: "Land Acquisition Strategy", color: NAVY, items: [
        "For any BDA e-auction site NBR did register for, execute bidding strategy now (10%-above-reserve threshold, single-bidder rejection rule) through the 28-31 Jul bidding rounds.",
        "The Bengaluru Business Corridor challenge is now fragmenting into segment-specific petitions (Madavara) as well as the broad scheme-wide case — cross-check whether any NBR-adjacent parcel sits near a segment already subject to its own petition, not just the corridor generally.",
        "Shriram Properties' new premium row-housing JDA in Yelahanka (₹600 Cr, 7 acres) is a reminder that low-rise premium formats are gaining traction beyond apartments — worth a quick feasibility look for any NBR parcel suited to that format.",
      ...
      { head: "Legal & Compliance", color: RED_RISK, items: [
        "GBA's voter-roll progress (88.92 lakh voters, 369 wards) is concrete, but the missed Supreme Court 30 June deadline means election timing is still unresolved — continue treating e-Khata/property-tax record continuity as an open diligence item.",
        "Track the Madavara-specific BBC petition and the broader Section 27 lapse case together — a segment-level ruling could set precedent for the whole scheme faster than the broad case resolves.",
        "If any NBR-adjacent parcel sits in Devanahalli's Channarayapatna hobli, continue to review the active KIADB land-resistance dispute there before treating consent or title as settled.",
      ]},
      { head: "Competitive Positioning", color: GREEN_POS, items: [
        "Puravankara's construction arm (Starworth/SICL) now executes work for both Embassy and Sattva — a reminder that Grade A peers' capacity and relationships are increasingly interconnected; map which contractors/construction arms NBR's own projects depend on for similar concentration risk.",
        "Brigade's Whitefield-Hoskote project re-rating from a ₹588 Cr land-cost figure to a ₹5,200 Cr GDV mixed-use bet is a reminder to track total project GDV, not just acquisition price, when benchmarking peer moves against NBR's own project economics.",
  ...
  layer2: {
    regional: [
      ...
      ["Telangana / Hyderabad", "Building on the 23 Jul Army-deployment order (Telangana HC warned the HYDRAA chief he could personally be taken into custody for non-compliance), the Telangana HC has separately ruled that GHMC cannot acquire private land without owner consent, reinforcing that acquisition must be voluntary and duly compensated. This follows the Telangana Cabinet's approval to merge 27 ORR-abutting municipalities into GHMC.", "Two judicial checks on Telangana state agencies within a week (personal-custody warning to HYDRAA's chief; a consent requirement on GHMC) suggest courts there are taking an increasingly interventionist posture — a modest positive for landholders' protections, but still a materially higher enforcement-friction environment than Karnataka for any NBR Hyderabad diligence."],
