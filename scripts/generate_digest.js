...
const CONTENT = {
  ...
  editionNo: "Vol. I — Edition 017",

  execSummary: [
    { tag: "HIGH", color: NAVY, text: "GBA now has a concrete transition date — it formally replaces BBMP from 2 September 2026, with Maheshwar Rao named as the incoming commissioner — the first firm milestone since the Supreme Court's 30 June completion deadline passed without a confirmed poll date." },
    { tag: "WATCH", color: AMBER_WATCH, text: "Sumadhura Group has signed a fresh JDA — ₹3,500 Cr GDV, 17 acres on the Whitefield-Kannamangala corridor, 2.5+ msf saleable (announced 4 Aug) — its second major East Bengaluru land move flagged in this digest inside two weeks, on top of its ~₹5,000 Cr 3-year Sumadhura Infracon investment plan." },
    { tag: "WATCH", color: AMBER_WATCH, text: "Both neighbouring-state RERAs are in flux simultaneously: TNRERA is running under a 6-month interim panel after its chairperson and two members resigned (from 14 Jul), while Telangana HC's HYDRAA-commissioner removal order is now facing public protest and a Chief Minister pledging the agency's anti-encroachment drive continues regardless." },
    { tag: "INFO", color: NAVY, text: "No new NBR-specific news; Karnataka's 2026 Land Reforms amendment further softens non-agricultural land-use penalties (3-year jail term + fine replaced by a flat ₹1 lakh civil fine), and the B-Khata→A-Khata window closes in just over two weeks (23 Aug)." },
  ],
  ...
  layer2: {
    regional: [
      ...
      ["Telangana / Hyderabad", "The Telangana HC's 1 Aug 2026 order directing HYDRAA Commissioner Ranganath's removal is now facing real political friction: Hyderabad residents have staged public protests against the order in support of Ranganath, and Chief Minister Revanth Reddy has stated HYDRAA's anti-encroachment drive will continue regardless of the leadership question. Separately, the cash-strapped state government is now planning to auction eligible HYDRAA-reclaimed government land (excluding lakes/ponds) via HMDA and TGIIC to raise revenue.", "The removal order is being actively contested in the court of public opinion, not just quietly implemented — NBR should not yet assume a softer or harsher HYDRAA posture either way. The land-monetisation plan is a new, distinct signal: government land freed up by HYDRAA enforcement may become available via HMDA/TGIIC auction, a potential Hyderabad-entry channel worth tracking if that market is ever on NBR's roadmap."],
    ...
    recommendations: [
      { head: "Regional Positioning", color: NAVY, items: [
        "The HYDRAA-commissioner removal order is now facing active public pushback and an explicit CM pledge that enforcement continues regardless — treat Hyderabad's regulatory posture as unsettled rather than assume either a softer or harsher outcome; revisit once the political standoff resolves.",
        "Telangana's plan to auction HYDRAA-reclaimed government land via HMDA/TGIIC is a new, distinct signal worth tracking — it could become a future entry channel into Hyderabad if that market is ever on NBR's roadmap, separate from the leadership question.",
      ...
      { head: "Legal Watch", color: RED_RISK, items: [
        "TNRERA is now operating under a 6-month interim panel (from 14 Jul 2026) after its chairperson and two members resigned — treat any TNRERA approval or registration sought during this window as subject to extra follow-up once permanent leadership is restored, if NBR ever pursues a Chennai entry or JV.",
