...
const CONTENT = {
  ...
  editionNo: "Vol. I — Edition 031",

  execSummary: [
    { tag: "HIGH", color: RED_RISK, text: "Karnataka HC (Lalitha S. v. Deputy Commissioner, WP 24040/2026, Justice R. Natraj, 13 Aug 2026) has ruled that GST cannot be deducted from land acquisition compensation, since compulsory acquisition is not a \"supply of goods or services\" under GST law — the Court ordered a refund with 15% interest, with recovery to be made personally from the officer who wrongly deducted it. A directly quantifiable protection for any NBR land compulsorily acquired by a government authority." },
    { tag: "WATCH", color: AMBER_WATCH, text: "The B-Khata→A-Khata 2% conversion window (15 May – 23 Aug 2026) closed yesterday with no extension announced — the standard 5%-of-guidance-value conversion fee is back in effect from today. Confirm with the legal team whether all pending NBR B-Khata filings were submitted in time to lock in the reduced rate." },
    { tag: "INFO", color: NAVY, text: "TNRERA has granted a 4-month completion-deadline extension (circular dated 10 Aug 2026) to registered projects affected by the West Asia conflict's supply-chain disruptions, treating the situation as \"war\" for RERA force-majeure purposes — no separate application or fee required. Relevant if NBR ever pursues a Chennai project." },
    { tag: "INFO", color: NAVY, text: "Kerala CM Satheesan (17 Aug 2026) announced a \"second phase\" of land reforms, including a law amendment to cut land-acquisition timelines for Vizhinjam Port expansion from 15 months to 6 — layering onto the already-contested Land Reforms 2.0 review. No new NBR-specific news or fresh Grade A/mid-tier Bengaluru land deal since the last edition." },
  ],
  ...
  layer2: {
    regional: [
      ...
      ["Telangana / Hyderabad", "A striking contrast has emerged alongside the HC's demolition restraint already on file: the state government has released the first ₹72 Cr tranche of a ₹200 Cr budget allocation for HYDRAA (office, vehicles, past-demolition costs) even as the agency remains barred from further demolitions pending a formal SOP. Commissioner Ranganath has separately gone public, alleging land mafias misled the courts and citing the Lothukunta case (Shantha Sriram; ~₹10,000 Cr government land; unauthorised heritage-rock blasting) as the kind of encroachment HYDRAA has been countering. Separately, via G.O.Ms.No.218 (14 Aug 2026), the state amended Rule 17(c) of the Telangana Building Rules, 2012 so that HMDA-issued TDR certificates can now be used or disposed of ANYWHERE within the HMDA area (not just where issued), and TG RERA has penalised three Hyderabad-based realtors for compliance violations. This layers onto the removal-order appeal, the Malkajgiri contempt proceeding, and five IAS/IPS contempt notices already on file.", "The government funding HYDRAA's operations while the court restrains its core enforcement activity signals continued political commitment to the agency's mission, not a retreat — NBR should expect HYDRAA's enforcement posture to resume at full strength once an SOP is filed. The TDR geographic-flexibility amendment is a genuine positive for any landowner (including NBR, should it ever hold Hyderabad-area development rights) surrendering land for public projects — certificates are no longer tied to a fixed redemption location, easing monetisation."],
