...
const CONTENT = {
  ...
  editionNo: "Vol. I — Edition 032",

  execSummary: [
    { tag: "WATCH", color: AMBER_WATCH, text: "Godrej Properties has acquired a further ~3.8 acres on Sarjapur Road, South Bengaluru (~₹2,400 Cr revenue potential) — combined with land it already holds in the same pocket, this creates a 30-acre tract (~3 million sq ft, ~₹3,500 Cr total revenue potential), reinforcing Sarjapur Road (inside NBR's core corridor) as Godrej's most active current Bengaluru assembly." },
    { tag: "INFO", color: NAVY, text: "Sumadhura Group has outlined plans for 6 new residential projects across Bengaluru — a ~₹6,000 Cr investment for ~4,000 apartments/plots across ~90 acres — a materially larger stated pipeline than the 17-acre Whitefield-Kannamangala JDA and 40-acre pipeline already on file." },
    { tag: "WATCH", color: AMBER_WATCH, text: "A 7-storey building collapse in Anjaiah Nagar, Gachibowli (Hyderabad) killed 2 workers, prompting HYDRAA Commissioner Ranganath to order a fresh unsafe-building identification and demolition drive — notable because it runs alongside, not instead of, the Telangana HC's still-pending SOP-conditioned restraint on HYDRAA's broader demolition activity." },
    { tag: "INFO", color: NAVY, text: "No public BDA response yet to the BBC Governor petition and no new Karnataka HC land ruling since the Lalitha S. GST-compensation decision; a fresh BDA e-auction round (69 sites across Anjanapura Township, Arkavathy Layout, Banashankari 6th Stage and Sir M. Visvesvaraya Layout) continues the ongoing site-supply cadence. No new NBR-specific news since the last edition." },
  ],
  ...
  layer1: {
    ...
    recommendations: [
      ...
      { head: "Competitive Positioning", color: GREEN_POS, items: [
        "Godrej's fresh ~3.8-acre Sarjapur Road acquisition (30-acre combined tract) and Sumadhura's ~₹6,000 Cr / 90-acre / 6-project Bengaluru pipeline are the two most concrete land-banking data points this week — both peers are compounding existing corridor positions rather than opening new ones, reinforcing Sarjapur Road specifically as an increasingly contested corridor for NBR.",
