...
const CONTENT = {
  ...
  editionNo: "Vol. I — Edition 033",

  execSummary: [
    { tag: "WATCH", color: AMBER_WATCH, text: "Puravankara has signed a fresh JDA for a 7.83-acre South-East Bengaluru parcel near the Electronic City corridor (Hosa Road/Hosur Road, Yellow Line metro access) — ₹1,100 Cr GDV, ~0.89 msf saleable — its 5th land transaction in FY27, taking cumulative FY27 business development to ~49.76 acres / ~₹6,300 Cr GDV / ~5.12 msf. Confirms Puravankara as the most consistently acquisitive Grade A peer this year." },
    { tag: "INFO", color: NAVY, text: "Brigade Group has acquired a 2-acre parcel in Whitefield, East Bengaluru for a premium residential project (~₹475 Cr GDV) — a further East Bengaluru entrant alongside its Kanakapura Road and Whitefield-Hoskote holdings already on file." },
    { tag: "INFO", color: NAVY, text: "A quiet day otherwise: no public BDA response yet to the BBC Governor petition, no fresh Karnataka HC land ruling since the Lalitha S. GST-compensation decision, no K-RERA leadership change, and no new NBR-specific news since the last edition." },
  ],
