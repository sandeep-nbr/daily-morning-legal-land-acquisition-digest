...
const CONTENT = {
  ...
  editionNo: "Vol. I — Edition 038",

  execSummary: [
    { tag: "INFO", color: NAVY, text: "The Election Commission's revised Special Intensive Revision (SIR) schedule for Karnataka is now more precise: draft electoral roll published 24 Aug 2026, claims & objections open 24 Aug – 23 Sept 2026, with disposal of claims/objections by 22 Oct 2026 — sharper than the \"concluding only by November\" estimate previously on file. This is the process the Supreme Court's 31 December 2026 GBA-election deadline depends on; the tighter October disposal date is a mild positive signal for that deadline holding." },
    { tag: "WATCH", color: AMBER_WATCH, text: "Telangana HC (1 Sept 2026) put HYDRAA Commissioner Ranganath's removal order ON HOLD, temporarily suspending a single judge's directive (issued in a Shantha Sriram Constructions contempt petition tied to the Lothukunta demolition dispute) that would have required the state government to remove him. A favourable near-term turn for HYDRAA's continuity, though the underlying contempt matter remains unresolved." },
    { tag: "INFO", color: NAVY, text: "Otherwise a quiet stretch: no new Grade A/mid-tier Bengaluru land deal, no fresh Karnataka HC land ruling since the Amit Garg K-RERA Registry decision, no public BDA response to the BBC Governor petition, and no developments in TNRERA, Amaravati or Kerala beyond what is already on file. No new NBR-specific news." },
  ],
