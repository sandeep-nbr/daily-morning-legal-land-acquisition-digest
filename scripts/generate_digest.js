...
const CONTENT = {
  ...
  editionNo: "Vol. I — Edition 008",

  execSummary: [
    { tag: "HIGH", color: RED_RISK, text: "Authorities are planning to deposit Bengaluru Business Corridor compensation directly in court and proceed with construction despite the pending Madavara petitions — SNC has emerged as lowest bidder for the first 19.5-19.8 km stretch, where BBCL has already acquired 523 of 665 acres (~79%) needed." },
    { tag: "WATCH", color: GREEN_POS, text: "HYDRAA Commissioner Ranganath has disclosed that all 63 contempt cases pending against him were filed by \"influential encroachers\" whose land-grabbing HYDRAA had stopped — a materially different framing than last week's Army-deployment coverage suggested, though the Telangana HC has separately called for his replacement." },
    { tag: "WATCH", color: AMBER_WATCH, text: "Prestige Group has secured BBMP/GBA approval to build a 1.5 km private flyover connecting Bellandur and Kariyammana Agrahara — a developer-funded infrastructure model that could reshape how Grade A players unlock connectivity-constrained land." },
    { tag: "WATCH", color: NAVY, text: "Shriram Properties is targeting up to ₹4,000 Cr in pre-sales by FY27, with Pune emerging alongside Bengaluru, Chennai and Kolkata as a growth market — context for its fresh Yelahanka JDA flagged yesterday." },
    { tag: "INFO", color: NAVY, text: "No new Karnataka High Court land-acquisition rulings, K-RERA enforcement orders, or gazette notification on the pending 10-15% guidance-value hike since yesterday — all previously flagged items (B-Khata window, GBA election timeline, BDA bidding rounds) remain live and unchanged." },
  ],
  ...
  layer1: {
    ...
    landAcquisition: [
      ...
      ["Bengaluru Business Corridor (ex-PRR)", "Construction is moving ahead of full legal resolution: SNC has emerged as lowest bidder (L1) for the first 19.5-19.8 km stretch (Madavara on Tumakuru Road to Ballari Road near Kempegowda International Airport), where project SPV Bengaluru Business Corridor Limited (BBCL) has already acquired 523 of the 665 acres needed (~79%); to avoid further delay, authorities are planning to deposit the compensation amount in court and proceed with construction despite the pending Madavara petitions and the broader 1,000+-objection, three-ground legal challenge and HUDCO funding-pressure campaign already on file.", "The court-deposit-and-proceed approach is a meaningful de-risking move for the project's construction timeline, but it does NOT resolve the underlying legal questions (Section 27 lapse, applicable law, compensation-package legality) — NBR's BBC-alignment land-banking survey should now separately track (a) physical construction progress and (b) the unresolved legal case, since the two may now move on different timelines."],
    ...
    recommendations: [
      { head: "Land Acquisition Strategy", color: NAVY, items: [
        ...
        "BBCL's court-deposit-and-proceed approach on the Bengaluru Business Corridor's first stretch signals the state intends to keep construction moving regardless of the unresolved legal challenge — treat corridor-adjacent land timing assumptions as now decoupled from the litigation outcome, and model physical construction progress separately from legal resolution.",
        "Prestige's developer-funded private flyover (Bellandur–Kariyammana Agrahara) is a new precedent for unlocking connectivity-constrained land via self-funded infrastructure — evaluate whether any NBR parcel with an access constraint could benefit from a similar BBMP/GBA-approved private-infrastructure structure.",
      ...
      { head: "Legal & Compliance", color: RED_RISK, items: [
        "Track the Bengaluru Business Corridor's construction progress (SNC's L1 bid, 79% land acquired on the first stretch) and its legal case (Section 27 lapse, Madavara petition) as two separate workstreams going forward, since the court-deposit approach means they may no longer move in lockstep.",
      ...
      { head: "Competitive Positioning", color: GREEN_POS, items: [
        ...
        "Shriram Properties' simultaneous geographic (Pune) and format (row-housing) diversification is a reminder that even quieter Grade A peers can move on multiple fronts at once — don't assume a quiet developer is a static one.",
  ...
  layer2: {
    regional: [
      ...
      ["Telangana / Hyderabad", "HYDRAA Commissioner Ranganath has publicly stated that all 63 contempt cases pending against him were filed by \"influential encroachers\" whose land-grabbing activities HYDRAA had stopped — a counter-narrative to the Army-deployment coverage, even as the Telangana HC has separately called for his replacement and ruled GHMC cannot acquire private land without owner consent.", "The dispute now has two competing narratives (HYDRAA as enforcement-overreach vs. HYDRAA as anti-encroachment enforcer targeted by those it stopped) — NBR's Hyderabad land diligence should treat this as genuinely contested rather than assume either narrative, and independently verify any parcel's encroachment/dispute history rather than relying on either side's framing."],
  ...
  sources: [
    ...
    "NewsMeter — HYDRAA Commissioner Ranganath contempt-case counter-narrative coverage",
